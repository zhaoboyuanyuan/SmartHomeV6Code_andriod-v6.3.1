...
function globalLang() {
	...
	window.device_A2_name = languageUtil.getResource("device_A2_name");
    window.lang_A2_add_button = languageUtil.getResource("device_A2_add_button");
    window.lang_A2_button_name_statu = languageUtil.getResource("device_A2_button_name_status");
    window.lang_A2_name_1 = languageUtil.getResource("device_A2_name_1");
    window.lang_A2_enter_name = languageUtil.getResource("device_A2_enter_name");
    window.lang_A2_status = languageUtil.getResource("device_A2_status");
    window.lang_A2_way = languageUtil.getResource("device_A2_way");
    window.lang_A2_action = languageUtil.getResource("device_A2_action"); 
    window.lang_A2_action_close = languageUtil.getResource("device_A2_action_close");
    window.lang_A2_action_open = languageUtil.getResource("device_A2_action_open");
    window.lang_A2_action_close_open = languageUtil.getResource("device_A2_action_close_open");
    window.lang_A2_action_open_close = languageUtil.getResource("device_A2_action_open_close");
    window.lang_A2_cancel =  languageUtil.getResource("device_A2_cancel");
    window.lang_A2_ok = languageUtil.getResource("device_A2_ok");
    window.lang_A2_close_time = languageUtil.getResource("device_A2_close_time");
    window.lang_A2_open_time = languageUtil.getResource("device_A2_open_time");
    window.lang_A2_s = languageUtil.getResource("device_A2_s");
    window.lang_A2_save = languageUtil.getResource("device_A2_save");
    window.lang_A2_re_edit = languageUtil.getResource("device_A2_re_edit");
    window.lang_A2_delete = languageUtil.getResource("device_A2_delete");
    window.lang_A2_delete_sure = languageUtil.getResource("device_A2_delete_sure");
	window.lang_A2_sent = languageUtil.getResource("device_A2_sent");
	window.lang_A2_initial_action = languageUtil.getResource("device_A2_initial_action");
	window.lang_A2_initial_action_hint = languageUtil.getResource("device_A2_initial_action_hint");
}
