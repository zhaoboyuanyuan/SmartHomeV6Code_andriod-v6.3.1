 ...
 */
function globalLang() {
    window.addDevice_43_name = languageUtil.getResource("addDevice_43_name");
    window.lang_fortifying = languageUtil.getResource("fortifying");
    window.lang_fortify = languageUtil.getResource("fortify");
    window.lang_disarming = languageUtil.getResource("disarming");
    window.lang_disarmed = languageUtil.getResource("disarmed");
    window.lang_offLine = languageUtil.getResource("offLine");
    window.lang_normal = languageUtil.getResource("normal");
    window.lang_warn = languageUtil.getResource("warn");
