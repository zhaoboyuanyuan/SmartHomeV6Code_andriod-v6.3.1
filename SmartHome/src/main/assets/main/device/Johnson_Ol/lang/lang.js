...
function globalLang() {
    ...
    window.lang_Details_Open = languageUtil.getResource("airsystem_Ol_open");//"已开机，点击关机";
    window.lang_Details_Close = languageUtil.getResource("device_Ol_off");//"已关机，点击开机";
    window.lang_Details_Temperature = languageUtil.getResource("device_Ol_Room_Temp_1");//室温";
    window.lang_Details_Type = languageUtil.getResource("device_Ol_mode");//"模式";
    window.lang_Details_Type1 = languageUtil.getResource("device_Ol_mode_cool");//"制冷";
    window.lang_Details_Type2 = languageUtil.getResource("device_Ol_mode_heat");//"制热";
    window.lang_Details_Type3 = languageUtil.getResource("device_Ol_mode_fan");//"通风";
    ...
    window.lang_Details_Speed = languageUtil.getResource("device_Ol_Wind_speed");//"风速";
    window.lang_Details_Speed1 = languageUtil.getResource("device_Ol_Wind_speed_high");//"高";
    window.lang_Details_Speed2 = languageUtil.getResource("device_Ol_Wind_speed_Medium");//"中";
    window.lang_Details_Speed3 = languageUtil.getResource("device_Ol_Wind_speed_low");//"低";
    window.lang_Details_Speed4 = languageUtil.getResource("device_Ol_mode_auto");//"自动";
    window.lang_Details_Offline = languageUtil.getResource("device_Ol_Offline");//"设备已离线";
    ...
    window.lang_device_Ol_Countdown_closed = languageUtil.getResource("device_Ol_Countdown_closed");//"后关闭";
    window.lang_device_Ol_Countdown_open = languageUtil.getResource("device_Ol_open_after");//"后开启";

    window.lang_device_Ol_Countdown_Off = languageUtil.getResource("device_Ol_Countdown_Off");//"倒计时关闭";
    window.lang_device_Ol_Countdown_Open = languageUtil.getResource("device_Ol_Countdown_Open");//"倒计时开启";

    window.lang_device_Ol_hour = languageUtil.getResource("device_Ol_hour");//"小时";
    window.lang_device_Ol_Minute = languageUtil.getResource("device_Ol_Minute");//"分钟";
    ...
    window.lang_device_Ol_Cancel = languageUtil.getResource("device_Ol_Cancel");//"取消";
    window.lang_device_Ol_ok = languageUtil.getResource("device_Ol_ok");//"确定";
}
