...
import cc.wulian.smarthomev6.main.device.camera_lc.setting.NVRDetailSettingActivity;
...
public class NVRDeviceDetailActivity extends BaseTitleActivity {
    ...
    public static void start(Context context, String deviceId, String token, int channelId, String channelName) {
        Intent intent = new Intent(context, NVRDeviceDetailActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lc_nvr_detail, true);
    ...
    protected void initView() {
        ...
        playWindow.initPlayWindow(NVRDeviceDetailActivity.this, (ViewGroup) findViewById(R.id.live_window_content), 0);
    }
    ...
    protected void initData() {
        ...
        setToolBarTitleAndRightImg(channelName, R.drawable.icon_cateye_setting);
        ...
        deviceApiUnit = new DeviceApiUnit(NVRDeviceDetailActivity.this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_alarmlist:
                LcCameraAlarmActivity.start(this, deviceId, String.valueOf(channelId));
                break;
            case R.id.iv_album:
            ...
            case R.id.iv_fullscreen_landscape:
                ...
                break;
            case R.id.img_right:
                NVRDetailSettingActivity.start(NVRDeviceDetailActivity.this, deviceId, String.valueOf(channelId), channelName);
                break;
...
//                        }
    ...
    public void onNvrChildDeviceNameEvent(NvrChildDeviceNameEvent event) {
        setTitleText(event.childDeviceName);
    }
}
