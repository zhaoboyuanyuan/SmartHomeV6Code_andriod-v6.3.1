 ...
 */
function globalLang() {
	window.noBinding = languageUtil.getResource("Device_32_Details_Unbound");
	window.Device_32_Details_Notbound = languageUtil.getResource("Device_32_Details_Notbound");
	window.Device_32_details_name = languageUtil.getResource("Device_32_details_name");
	window.Device_32_Details_Confirm = languageUtil.getResource("Device_32_Details_Confirm");
	window.deviceDefaultName = languageUtil.getResource("Device_32_details_name");
