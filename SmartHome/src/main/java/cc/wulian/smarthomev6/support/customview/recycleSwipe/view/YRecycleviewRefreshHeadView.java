    ...
    public void setState(int status) {
        ...
        switch (status) {
            case STATE_NORMAL:
                ...
                tv_y_recycleview_head_refresh_status.setText(R.string.CateEye_Album_pull_refresh);
                break;
            ...
            case STATE_RELEASE_TO_REFRESH:
                ...
                if (mStatus != STATE_RELEASE_TO_REFRESH) {
                    ...
                    tv_y_recycleview_head_refresh_status.setText(R.string.CateEye_Album_release_refresh);
                }
                break;
            case STATE_REFRESHING:
                tv_y_recycleview_head_refresh_status.setText(R.string.CateEye_Album_refresh_now);
                break;
            case STATE_DONE:
                tv_y_recycleview_head_refresh_status.setText("");
                break;
            default:
        }
        mStatus = status;
