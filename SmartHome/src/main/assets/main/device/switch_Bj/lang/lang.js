 ...
 */
function globalLang() {
    window.device_Bj_name = languageUtil.getResource("Device_Bj_details_name")//"回家/离家场景开关"
    window.device_gohome_unBind = languageUtil.getResource("Device_Bj_gohome_Unbound")//"回家未绑定"
    window.device_away_unBind = languageUtil.getResource("Device_Bj_away_Unbound")//"离家未绑定"
    window.device_gohome_bind = languageUtil.getResource("Device_Bj_gohome_Bound")//"回家已绑定"
    window.device_away_bind = languageUtil.getResource("Device_Bj_away_Bound")//"离家已绑定
    window.device_overTime = languageUtil.getResource("Device_Bj_Overtime")//"请求超时，请重试"
}
