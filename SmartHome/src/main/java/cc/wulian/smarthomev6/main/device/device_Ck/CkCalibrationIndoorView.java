package cc.wulian.smarthomev6.main.device.device_Ck;
...
public class CkCalibrationIndoorView extends LinearLayout implements IDeviceMore {

    private static String TAG = CkCalibrationIndoorView.class.getSimpleName();
    ...
    public CkCalibrationIndoorView(Context context) {
        super(context);
    ...
    private void initView(Context context) {
        View rootView = LayoutInflater.from(context).inflate(R.layout.item_device_more_custom_ck_tmp_check, null);
    ...
    private void sendCmd(int index) {
        ...
        try {
            ...
            int commandId = value < 0 ? 0x8014 : 0x8013;
            object.put("cmd", "501");
