 ...
 */
function globalLang() {
	window.lang_noalarm = languageUtil.getResource("IfAlarm");
	window.lang_alarming = languageUtil.getResource("alarming");
	window.lang_01name = languageUtil.getResource("VolAlarm_tittle");
