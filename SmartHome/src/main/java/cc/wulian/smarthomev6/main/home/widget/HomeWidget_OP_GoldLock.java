 ...
 * Function:    金指码门锁(OP) 首页widget
 */

public class HomeWidget_OP_GoldLock extends RelativeLayout implements IWidgetLifeCycle {

    private static final String TAG = HomeWidget_OP_GoldLock.class.getSimpleName();
    ...
    private LinearLayout relativeStatus;
    ...
    private TextView textMainLock, textMainState, textStatus;
    ...
    public HomeWidget_OP_GoldLock(Context context) {
        super(context);
    ...
    private void initView(final Context context) {
        ...
        relativeStatus = (LinearLayout) rootView.findViewById(R.id.jzm_lock_relative_status);
    ...
    private void updateBatteryLevel(String battery) {
        switch (battery) {
            case "01":
                ...
                break;
            default:
                ivBattery.setVisibility(INVISIBLE);
        }
    }
