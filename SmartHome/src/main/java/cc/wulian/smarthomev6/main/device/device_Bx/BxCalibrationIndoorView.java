...
public class BxCalibrationIndoorView extends LinearLayout implements IDeviceMore {

    private static String TAG = BxCalibrationIndoorView.class.getSimpleName();
    ...
    public BxCalibrationIndoorView(Context context) {
        super(context);
