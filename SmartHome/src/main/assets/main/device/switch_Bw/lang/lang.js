...
function globalLang() {
    ...
    window.switch_Bw_ChangeMode02 = languageUtil.getResource("switch_Bw_ChangeMode02") //切换后原有已绑定设备将解除绑定
    window.switch_Bw_ChangeMode03 = languageUtil.getResource("switch_Bw_ChangeMode03") //切换后原有已绑定场景将解除绑定
    window.switch_Ao_03 = languageUtil.getResource("switch_Ao_03") //該綁定設備為窗帘控制器，解綁其中一個按鍵則三鍵全部解綁，確認全部解除綁定嗎？
