...
public class LookEverInformationActivity extends BaseTitleActivity implements View.OnClickListener, IcamMsgEventHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.activity_lookever_information, true);
...
//                    showUpdateDialog();
    ...
    private void showUpdateDialog() {
        ...
        mNotifyUpdateDialog = DialogUtil.showCommonDialog(this,
                ...
                rs.getString(R.string.Talk_Later), new WLDialog.MessageListener() {
                    @Override
