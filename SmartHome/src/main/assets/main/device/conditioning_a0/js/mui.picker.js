...
(function ($, window, document, undefined) {
    ...
    Picker.prototype.bindEvent = function () {
        ...
        self.holder.addEventListener($.EVENT_START, function (event) {
            ...
            if (!((deviceMode == "1" || deviceMode == "2") && deviceState == "1")) {
                return;
            }
        ...
        setTimeout(function () {
            ...
            if (deviceSetTemperature && isNeedHandleTemp) {
                ...
                if (shownum != deviceSetTemperature) {
                    ...
                    if (deviceMode == "1") {
                        //制冷
                        if ((shownum <= deviceCoolMaxTemperature && shownum >= deviceCoolMinTemperature) || (!deviceCoolMinTemperature || !deviceCoolMaxTemperature)) {
                            setThermostatTemperature(shownum);
                        }
                    } else if (deviceMode == "2") {
                        //制冷
                        if ((shownum <= deviceHeatMaxTemperature && shownum >= deviceHeatMinTemperature) || (!deviceHeatMinTemperature || !deviceHeatMaxTemperature)) {
                            setThermostatTemperature(shownum);
                        }
                    }
