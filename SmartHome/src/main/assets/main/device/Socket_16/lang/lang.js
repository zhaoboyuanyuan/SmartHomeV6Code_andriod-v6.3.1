 ...
 */
function globalLang() {
	window.lang_sms = languageUtil.getResource("device_16_Log")// "日志"
    window.device_16_name = languageUtil.getResource("device_16_name")//"移动插座计量版"
    window.device_16_open = languageUtil.getResource("device_16_open")//"已打开"
    window.device_16_close = languageUtil.getResource("device_16_Close")//"已关闭"
}
