...
public class LookEverProtectSettingActivity extends BaseTitleActivity implements IcamMsgEventHandler, View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lookever_protect_setting, true);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.rl_protect_area:
                startActivityForResult(
                        (new Intent(this, LookEverProtectAreaActivity.class))
