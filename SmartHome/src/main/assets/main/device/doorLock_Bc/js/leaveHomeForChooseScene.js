...
function itemOnClick(){
	...
	/*if(chooseSceneid!=null&&chooseSceneid!=undefined&&chooseSceneid!=""){
		sceneChoose="sceneChoose_"+chooseSceneid;		
		document.getElementById(sceneChoose).style.visibility="hidden";
	}*/
...
//	 sceneChoose="sceneChoose_"+chooseSceneid;
//	 document.getElementById(sceneChoose).style.display="block";
...
function selectItem(sceneid){
	...
	if(chooseSceneid==bindingSceneid){
		document.getElementById("bindingScene").innerText=chooseScene_js_03;//解绑
	}else{
		document.getElementById("bindingScene").innerText=chooseScene_js_02;//绑定
	}
}
