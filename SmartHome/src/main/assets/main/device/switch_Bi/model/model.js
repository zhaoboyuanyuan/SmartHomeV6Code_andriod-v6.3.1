...
MVC.M = {
    ...
    dealBindInfo: function (data) {
        MVC.M.clearContent();
        var bindList = data;
        var bindInfo = bindList[0];
        var endPointNum = bindInfo.endpointNumber;
        var sceneID = bindInfo.sceneID;
        MVC.M.bindMapSet(endPointNum, sceneID);
        var keyText = document.getElementById("key1");
        var sceneImg = document.getElementById("scene1");
        var keyImg = document.getElementById("keyImg1");
