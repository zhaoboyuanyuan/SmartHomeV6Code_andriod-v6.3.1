 ...
 */
function globalLang() {
    window.title_name = languageUtil.getResource("device_A0_name");
    ...
    window.device_tip_1 = languageUtil.getResource("CO2_level_1");
    window.device_tip_2 = languageUtil.getResource("CO2_level_2");
    window.device_tip_3 = languageUtil.getResource("CO2_level_3");
    window.lang_hour = languageUtil.getResource("CO2_Statistics_h");
}
