...
public class TvRemoteMainActivity extends BaseTitleActivity {
    ...
    public static void startForScene(Activity context, String deviceID, String type, String name, String brand, String pick, String time) {
        Intent intent = new Intent(context, TvRemoteMainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stb_main, true);
    }
...
//                    customViewAdapter.update(list);
    ...
    private void setTitle() {
        if (TextUtils.equals(mode, MODE_CONTROL)) {
            if (isSceneOrHouseKeeper){
                if (TextUtils.isEmpty(mName)) {
                    if (TextUtils.equals(type, "T")) {
                        ...
                        setToolBarTitle(mainApplication.getResources().getString(R.string.Infraredrelay_Addremote_Settopbox));
                    }
                } else {
                ...
                if (TextUtils.isEmpty(mName)) {
                    if (TextUtils.equals(type, "T")) {
                        ...
                        setToolBarTitleAndRightImg(mainApplication.getResources().getString(R.string.Infraredrelay_Addremote_Settopbox), R.drawable.icon_more);
                    }
                } else {
            ...
            if (TextUtils.isEmpty(mName)) {
                if (TextUtils.equals(type, "T")) {
                    setToolBarTitleAndRightBtn(mainApplication.getResources().getString(R.string.Infraredrelay_Addremote_Television), getResources().getString(R.string.Save));
                } else if (TextUtils.equals(type, "C")) {
                    setToolBarTitleAndRightBtn(mainApplication.getResources().getString(R.string.Infraredrelay_Addremote_Settopbox), getResources().getString(R.string.Save));
                }
            } else {
...
//                            customViewAdapter.update(list);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_right:
                //更多
                ControllerMoreActivity.start(TvRemoteMainActivity.this, deviceID, createTime, mName, type);
                break;
            default:
                break;
        }
    ...
    public void sendDeleteCmd(String tag) {
        ...
        try {
            ...
            array.put(data.toString().toUpperCase());
            object.put("parameter", array);
            progressDialogManager.showDialog(DELETE, TvRemoteMainActivity.this, getString(R.string.Device_List_Delete), null, getResources().getInteger(R.integer.http_timeout));
            MainApplication.getApplication()
                    .getMqttManager()
                    .publishEncryptedMessage(object.toString(), MQTTManager.MODE_GATEWAY_FIRST);
        } catch (JSONException e) {
    ...
    private void saveCustomRemoteInfo() {
        ...
        progressDialogManager.showDialog(SAVE, TvRemoteMainActivity.this, getString(R.string.Disposing), null, getResources().getInteger(R.integer.http_timeout));
