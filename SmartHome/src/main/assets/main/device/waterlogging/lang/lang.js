...
function globalLang() {
    ...
    window.lang_normal = languageUtil.getResource("normal")//"正常"
    window.lang_warn = languageUtil.getResource("warn_01")//"有漏水"
    window.lang_name_06 = languageUtil.getResource("addDevice_06_name")//"水浸监测器"
    window.lang_Alarm = languageUtil.getResource("Alarm")//"水浸监测器"
    window.lang_Log = languageUtil.getResource("Log")//"水浸监测器"
}
