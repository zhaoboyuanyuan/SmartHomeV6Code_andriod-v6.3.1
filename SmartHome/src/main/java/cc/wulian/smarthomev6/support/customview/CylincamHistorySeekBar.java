...
public class CylincamHistorySeekBar extends View {
	...
	public CylincamHistorySeekBar(Context paramContext) {
...
//							+ mCurrentMidTimeStamp);
					mHistroySeekChangeListener.onChangeSeekBarFinalAction(
							mCurrentMidTimeStamp, isMidRecord,numberFileName);
				}
	...
	public interface HistroySeekChangeListener {
		...
		// int  这样的话 就限定死了文件的个数，要注意不能超过限制。
		public void onChangeSeekBarFinalAction(long timeStamp, boolean isRecord, int number);
