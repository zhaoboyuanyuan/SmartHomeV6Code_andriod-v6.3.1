...
function editPopup(data){
    ...
    if(data.num == 0){
        ...
        document.getElementsByClassName("two_row")[0].style.marginTop = "1.5rem"
        ...
        document.getElementsByClassName("popup")[0].appendChild(title)
        document.getElementsByClassName("popup")[0].appendChild(input)
    }
    ...
    a1.style.height = "4rem"
    a1.style.lineHeight = "4rem"
    a1.style.textAlign = "center"
    a1.style.fontSize = "1.4rem"
    a1.style.color = "#000"
    a1.style.textDecoration = "none"

    if(data.isClick != 0){
        document.getElementsByClassName("popup")[0].appendChild(btn)
        var btnClass = document.getElementsByClassName("btn")[0]
        //一个按钮
        if(data.isClick == 1){
