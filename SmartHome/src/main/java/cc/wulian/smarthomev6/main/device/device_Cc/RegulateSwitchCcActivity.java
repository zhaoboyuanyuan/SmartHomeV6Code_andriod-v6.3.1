...
import cc.wulian.smarthomev6.main.device.device_Av.RegulateSwitchAvMoreActivity;
...
public class RegulateSwitchCcActivity extends BaseTitleActivity {
    ...
    public static void start(Context context, String deviceID) {
        Intent intent = new Intent(context, RegulateSwitchCcActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_cc, true);
                                ...
                                if (attribute.attributeId == 0x0011) {
                                    ...
                                    if (!TextUtils.isEmpty(attribute.attributeValue)) {
                                        try {
                                            ...
                                            float a = result / 100f;
                                            regulate_switch.setPercent(a);
                                        } catch (Exception e) {
                                            WLog.e("huxc", "attributeValue is num");
                                        }
                                    }
                                }
                            }
    ...
    private void startMore() {
        Intent intent = new Intent(RegulateSwitchCcActivity.this, RegulateSwitchCcMoreActivity.class);
