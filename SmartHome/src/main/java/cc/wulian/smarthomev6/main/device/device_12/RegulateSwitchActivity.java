package cc.wulian.smarthomev6.main.device.device_12;
...
public class RegulateSwitchActivity extends BaseTitleActivity {
    ...
    public static void start(Context context, String deviceID) {
        Intent intent = new Intent(context, RegulateSwitchActivity.class);
...
//                                            }
    ...
    private void startMore() {
        ...
        Intent intent = new Intent(RegulateSwitchActivity.this, DeviceMoreActivity.class);
