...
public class InstTestRunner extends android.test.InstrumentationTestRunner {
     ...
     */
    public String getTestResultDir(Context context) {
    ...
    public XmlSerializer newSerializer(Writer writer) {
        try {
