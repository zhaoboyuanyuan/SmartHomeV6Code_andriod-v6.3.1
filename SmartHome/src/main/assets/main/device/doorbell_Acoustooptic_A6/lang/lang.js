 ...
 */
function globalLang() {
    window.lang_name_A6 = languageUtil.getResource("DoorbellAlarm_name")//"门铃声光器"
    window.lang_Log = languageUtil.getResource("Log")//"日志"
    window.lang_Alarm = languageUtil.getResource("Alarm")//"报警消息"
    window.lang_Alarm = languageUtil.getResource("Alarm")//"报警消息"
    window.lang_DoorbellAlarm_tips1 = languageUtil.getResource("DoorbellAlarm_tips1")//"关闭门铃"
    window.lang_DoorbellAlarm_tips2 = languageUtil.getResource("DoorbellAlarm_tips2")//"开启门铃"
}
