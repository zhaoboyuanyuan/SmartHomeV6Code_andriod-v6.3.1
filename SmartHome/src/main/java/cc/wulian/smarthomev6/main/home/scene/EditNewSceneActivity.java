...
public class EditNewSceneActivity extends H5BridgeActivity {

    private String state, name, id, icon, programID;
...
//    private WVJBWebViewClient.WVJBResponseCallback callback_508;
    ...
    protected void init() {
        ...
        map.put("scenestate", state);
        map.put("sceneName", name);
        map.put("sceneID", id);
        map.put("sceneIcon", icon);
    ...
    public static void start(Context context,
                             ...
                             String icon,
                             String programID) {
        Intent intent = new Intent(context, EditNewSceneActivity.class);
    ...
    protected void registerHandler() {
        mWebViewClient.registerHandler("isSceneExist", new WVJBWebViewClient.WVJBHandler() {
            ...
            public void request(Object data, WVJBWebViewClient.WVJBResponseCallback callback) {
                SceneManager sceneManager = new SceneManager(EditNewSceneActivity.this);
        ...
        mWebViewClient.registerHandler("scene_503", new WVJBWebViewClient.WVJBHandler() {
            ...
            public void request(Object data, WVJBWebViewClient.WVJBResponseCallback callback) {
                ...
                SceneManager s = new SceneManager(EditNewSceneActivity.this);
                s.snedMqttMessage((JSONObject) data);
                progressDialogManager.showDialog("Change", EditNewSceneActivity.this, null, new CustomProgressDialog.OnDialogDismissListener() {
                    @Override
...
//                callback_508 = callback;
        ...
        mWebViewClient.registerHandler("WLHttpGetBase", new WVJBWebViewClient.WVJBHandler() {
            ...
            public void request(Object data, final WVJBWebViewClient.WVJBResponseCallback callback) {
                ...
                try {
                    ...
                    new DeviceApiUnit(EditNewSceneActivity.this).doBridgeGet(url, map, new DeviceApiUnit.DeviceApiCommonListener() {
                        @Override
        ...
        mWebViewClient.registerHandler("getSTCameraPrz", new WVJBWebViewClient.WVJBHandler() {
            ...
            public void request(Object data, final WVJBWebViewClient.WVJBResponseCallback callback) {
                ...
                new DataApiUnit(EditNewSceneActivity.this).doGetPositionForH5(data.toString(), new DataApiUnit.DataApiCommonListener<Object>() {
                    @Override
                    public void onSuccess(Object bean) {
                        callback.callback(bean);
                    }
...
//            callback_508.callback(jsonObject);
        ...
        try {
            ...
            if ("C".equals(operType)) {
                ...
                if ("0".equals(type)) {
                    ...
                    SceneManager manager = new SceneManager(EditNewSceneActivity.this);
    ...
    protected String getUrl() {
        return HttpUrlKey.URL_EDIT_NEW_SCENE;
    }
