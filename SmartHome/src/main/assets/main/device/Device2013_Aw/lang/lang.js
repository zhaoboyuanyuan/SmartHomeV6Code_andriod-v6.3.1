 ...
 */
function globalLang() {
	window.device_name_Aw = languageUtil.getResource("device_Aw_name");
	window.Device_Aw_Notbind = languageUtil.getResource("device_Aw_NotBound");
	window.Device_Aw_Switch_open = languageUtil.getResource("device_Aw_on");
	window.Device_Aw_Switch_close = languageUtil.getResource("device_Aw_off");
