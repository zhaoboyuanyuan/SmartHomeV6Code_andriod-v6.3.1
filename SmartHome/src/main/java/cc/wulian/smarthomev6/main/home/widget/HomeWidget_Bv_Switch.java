...
public class HomeWidget_Bv_Switch extends FrameLayout implements IWidgetLifeCycle, View.OnClickListener {
    ...
    public HomeWidget_Bv_Switch(@NonNull Context context) {
        super(context);
        mContext = context;
        initView(context);
    }

    public HomeWidget_Bv_Switch(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView(context);
    }
