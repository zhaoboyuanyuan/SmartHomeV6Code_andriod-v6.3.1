 ...
 */
function globalLang() {
    window.device_Ck_name	= languageUtil.getResource("device_Ck_name");
    window.lang_Log = languageUtil.getResource("Log");
    window.airsystem_Ck_Wind_speed_low = languageUtil.getResource("airsystem_Ck_Wind_speed_low");
    window.airsystem_Ck_Wind_speed_medium = languageUtil.getResource("airsystem_Ck_Wind_speed_medium");
    window.airsystem_Ck_Wind_speed_high = languageUtil.getResource("airsystem_Ck_Wind_speed_high");
    window.device_Ck_open_after = languageUtil.getResource("device_Ck_open_after");
    window.device_Ck_Countdown_closed = languageUtil.getResource("device_Ck_Countdown_closed");
    window.Device_Ck_Details_Time7 = languageUtil.getResource("Device_Ck_Details_Time7");
    window.Device_Ck_Details_Time8 = languageUtil.getResource("Device_Ck_Details_Time8");
    window.Device_Ck_Cancel = languageUtil.getResource("Device_Ck_Cancel");
    window.Device_Ck_OK = languageUtil.getResource("Device_Ck_OK");
    window.Device_Ck_Details_Time = languageUtil.getResource("Device_Ck_Details_Time");
}
