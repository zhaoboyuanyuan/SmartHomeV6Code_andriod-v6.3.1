 ...
 * Function:    恢复出厂
 */
public class BmSystemResetView extends LinearLayout implements IDeviceMore {

    private static String TAG = BmSystemResetView.class.getSimpleName();
    ...
    public BmSystemResetView(Context context) {
        super(context);
