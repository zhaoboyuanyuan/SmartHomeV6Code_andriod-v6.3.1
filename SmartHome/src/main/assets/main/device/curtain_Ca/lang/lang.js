 ...
 */
function globalLang() {
    window.device_Ca_name = languageUtil.getResource("device_Ca_name");
    window.lang_Ca_mode = languageUtil.getResource("device_Ca_mode");//模式切换
    window.lang_Ca_motor = languageUtil.getResource("device_Ca_Motor_reversal")//电机反转
