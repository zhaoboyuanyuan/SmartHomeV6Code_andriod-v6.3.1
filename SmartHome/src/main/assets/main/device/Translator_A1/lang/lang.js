 ...
 */
function globalLang() {
    window.lang_name_A1 = languageUtil.getResource("device_A1_name");//"四路输入型翻译器";
    window.lang_device_way = languageUtil.getResource("device_A1_way");//"路";
    window.lang_device_disarmed = languageUtil.getResource("device_A1_disarmed");//"已撤防";
    window.lang_device_fortifying = languageUtil.getResource("device_A1_fortifying");//"设防中";
    window.lang_device_disarming = languageUtil.getResource("device_A1_disarming");//"撤防";
    window.lang_device_fortify = languageUtil.getResource("device_A1_fortify");//"设防";
    window.lang_device_abnormal = languageUtil.getResource("device_A1_abnormal");//"有报警";
    window.lang_device_normal = languageUtil.getResource("device_A1_normal");//"正常";
    window.lang_device_close = languageUtil.getResource("device_A1_action_close");//"闭合";
    window.lang_device_open = languageUtil.getResource("device_A1_action_open");//"断开";
    window.lang_device_noData = languageUtil.getResource("device_A1_noData");//"暂无消息";
}
