 ...
 */
function globalLang() {
	window.lang_sms = languageUtil.getResource("device_25_Log")// "日志"
    window.device_25_name = languageUtil.getResource("device_25_name")//"电动机械手"
    window.device_25_open = languageUtil.getResource("device_25_open")
    window.device_25_close = languageUtil.getResource("device_25_Close")
    window.device_25_unknownstate = languageUtil.getResource("device_25_Unknownstate")
}
