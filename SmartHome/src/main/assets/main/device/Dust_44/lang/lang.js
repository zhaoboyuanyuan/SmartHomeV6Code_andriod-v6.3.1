 ...
 */
function globalLang() {
    window.title_name = languageUtil.getResource("device_44_name");
    window.device_state_1 = languageUtil.getResource("Dust_excellent");
    window.device_state_2 = languageUtil.getResource("Dust_fine");
    window.device_state_3 = languageUtil.getResource("Dust_bad");
    window.device_tip_1 = languageUtil.getResource("Dust_level_1");
    window.device_tip_2 = languageUtil.getResource("Dust_level_2");
    window.device_tip_3 = languageUtil.getResource("Dust_level_3");
    window.lang_hour = languageUtil.getResource("Dust_hour");
}
