...
public class SwipeRefreshLayout extends FrameLayout implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = cc.wulian.smarthomev6.support.customview.SwipeRefreshLayout.class.getSimpleName();
    ...
    /**
     * Set a callback to override {@link cc.wulian.smarthomev6.support.customview.SwipeRefreshLayout#canChildScrollUp()} method. Non-null
...
//        }
        ...
        float rotation = (-0.25f + .4f * adjustedPercent + tensionPercent * 2) * .8f;
