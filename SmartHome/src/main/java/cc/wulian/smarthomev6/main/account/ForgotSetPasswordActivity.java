...
public class ForgotSetPasswordActivity extends BaseFullscreenActivity {
    ...
    public static void start(Context context, String account) {
        Intent intent = new Intent(context, ForgotSetPasswordActivity.class);
    ...
    private void reset(String password) {
        ...
        if (!(RegularTool.isLegalChinaPhoneNumber(account) || RegularTool.isLegalEmailAddress(account))) {
            ...
            progressDialogManager.showDialog(RESET, this, null, null, getResources().getInteger(R.integer.http_timeout));
            ssoApiUnit.doUpdateAndLoginByAccount(account, null, password, new SsoApiUnit.SsoApiCommonListener<RegisterPhoneBean>() {
                @Override
                public void onSuccess(RegisterPhoneBean bean) {
                    progressDialogManager.dimissDialog(RESET, 0);
                    SigninActivity.start(ForgotSetPasswordActivity.this, account);
                }
