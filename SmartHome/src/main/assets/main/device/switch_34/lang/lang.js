 ...
 */
function globalLang() {
	window.noBinding = languageUtil.getResource("device_34_Unbound");
	window.noBind = languageUtil.getResource("device_34_Unbound");
	window.bindTip = languageUtil.getResource("device_34_BindingScene");
	window.finished = languageUtil.getResource("device_34_Done");
	window.deviceDefaultName = languageUtil.getResource("device_type_34_name");
