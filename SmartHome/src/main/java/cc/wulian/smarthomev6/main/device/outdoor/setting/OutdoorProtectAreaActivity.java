...
/**
 * Created by hxc on 2017/10/9.
 * func:户外机防护区域界面
 */

public class OutdoorProtectAreaActivity extends Activity implements View.OnClickListener {
    private  static final String TAG = "OutdoorProtectAreaActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoor_protect_area);
        initView();
        initData();
        initListeners();
    }
