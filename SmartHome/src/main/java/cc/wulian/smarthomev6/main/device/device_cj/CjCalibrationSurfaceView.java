...
public class CjCalibrationSurfaceView extends LinearLayout implements IDeviceMore {

    private static String TAG = CjCalibrationSurfaceView.class.getSimpleName();
    ...
    public CjCalibrationSurfaceView(Context context) {
        super(context);
