...
public class HomeWidget_Ar_MetalCurtain extends RelativeLayout implements IWidgetLifeCycle,View.OnClickListener{
    ...
    public HomeWidget_Ar_MetalCurtain(Context context) {
        super(context);
    ...
    private void initView(Context context){
        final View rootView = LayoutInflater.from(context).inflate(R.layout.view_home_ar_metal_curtain, null);
