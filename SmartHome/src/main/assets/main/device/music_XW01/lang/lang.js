 ...
 */
function globalLang() {
    window.Music_Countdown_close	= languageUtil.getResource("Music_Countdown_close");
    window.Music_30_min	            = languageUtil.getResource("Music_30_min");
    window.Music_60_min	            = languageUtil.getResource("Music_60_min");
    window.Music_120_min	        = languageUtil.getResource("Music_120_min");
    window.Music_open_later	        = languageUtil.getResource("Music_open_later");
    window.Music_close_later	    = languageUtil.getResource("Music_close_later");
    window.Music_unknown	        = languageUtil.getResource("Music_unknown");
    window.lang_name_XW01 = languageUtil.getResource("device_name_XW01");
}
