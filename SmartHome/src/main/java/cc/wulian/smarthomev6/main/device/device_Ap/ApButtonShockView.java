 ...
 */
public class ApButtonShockView extends LinearLayout implements IDeviceMore {

    private static String TAG = ApButtonShockView.class.getSimpleName();
    ...
    public ApButtonShockView(Context context) {
        super(context);
    ...
    private void initView(Context context) {
        View rootView = LayoutInflater.from(context).inflate(R.layout.item_device_more_custom_bm_button_shock, null);
        ...
        EndpointParser.parse(device, new EndpointParser.ParserCallback() {
            ...
            public void onFindAttribute(Endpoint endpoint, Cluster cluster, Attribute attribute) {
                if (attribute.attributeId == 0x8002) {
                    boolean s = TextUtils.equals(attribute.attributeValue.substring(14, 16), "01");
