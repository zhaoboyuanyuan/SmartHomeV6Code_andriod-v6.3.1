 ...
 */
function globalLang() {
    window.lang_socket_01 = languageUtil.getResource("device_62_Title");
    window.lang_socket_open = languageUtil.getResource("device_62_Alreadyopen");
    window.lang_socket_close = languageUtil.getResource("device_62_Closed");
    ...
    window.device_switch = languageUtil.getResource("device_switch");
}
