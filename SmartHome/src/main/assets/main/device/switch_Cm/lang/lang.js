...
function globalLang() {
	...
	window.switch_Cm_NoSwitchMode = languageUtil.getResource("switch_Cm_NoSwitchMode") // 非开关模式，请至设备端控制
    ...
    window.switch_Cm_Saving = languageUtil.getResource("switch_Cm_Saving") //正在保存
    ...
    window.switch_Cm_ChangeMode02 = languageUtil.getResource("switch_Cm_ChangeMode02") //切换后原有已绑定设备将解除绑定
