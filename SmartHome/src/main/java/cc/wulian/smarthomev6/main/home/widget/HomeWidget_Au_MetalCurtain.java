...
public class HomeWidget_Au_MetalCurtain extends RelativeLayout implements IWidgetLifeCycle,View.OnClickListener{
    ...
    public HomeWidget_Au_MetalCurtain(Context context) {
        super(context);
