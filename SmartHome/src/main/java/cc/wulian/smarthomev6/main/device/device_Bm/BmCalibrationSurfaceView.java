...
public class BmCalibrationSurfaceView extends LinearLayout implements IDeviceMore {

    private static String TAG = BmCalibrationSurfaceView.class.getSimpleName();
    ...
    public BmCalibrationSurfaceView(Context context) {
        super(context);
    ...
    private void initView(Context context) {
        ...
        mTextName.setText(R.string.Device_Surfacedoortpcorrect);
        ...
        mBottomMenu.setTitle(getResources().getString(R.string.Device_Surfacedoortpcorrect));
            ...
            public void onFindAttribute(Endpoint endpoint, Cluster cluster, Attribute attribute) {
                if (cluster.clusterId == 0x0201) {
                    if (attribute.attributeId == 0x8001) {
                        try {
                            tempIndex = hexStringToTempIndex(attribute.attributeValue.substring(40, 42));
    ...
    private void sendCmd(int index) {
        ...
        try {
            ...
            int commandId = value < 0 ? 0x801D : 0x801C;
            object.put("cmd", "501");
            ...
            array.put(valueToHexString((int) Math.abs(value * 10)));
