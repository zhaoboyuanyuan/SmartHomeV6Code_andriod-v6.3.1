...
function globalLang() {
    ...
    window.device_Ba_name = languageUtil.getResource("device_Ba_name")//"两位插座"
    window.device_Ba_RealtimePower = languageUtil.getResource("device_Ba_RealtimePower")//"实时功率";
    window.device_Ba_electricity = languageUtil.getResource("device_Ba_electricity")//"累计电量";
    window.device_Ba_DataStatistics = languageUtil.getResource("device_Ba_DataStatistics")//"用电数据统计";
    window.device_Ba_hour = languageUtil.getResource("device_Ba_hour")//"时";
    window.device_Ba_day = languageUtil.getResource("device_Ba_day")//"天";
    window.device_Ba_week = languageUtil.getResource("device_Ba_week")//"周";
    window.device_Ba_month = languageUtil.getResource("device_Ba_month")//"月";
    window.device_Ba_Electric = languageUtil.getResource("device_Ba_Electric")//"电量：";
    window.device_Ba_unit = languageUtil.getResource("device_Ba_unit")//"单位：";
    window.device_Ba_content = languageUtil.getResource("device_Ba_content");//"检测到用电器功率超出额定范围，已为您自动断电";
    window.device_Ba_Button = languageUtil.getResource("device_Ba_Button");//"确定";
}
