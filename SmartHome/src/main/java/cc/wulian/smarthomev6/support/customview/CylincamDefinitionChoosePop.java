...
public class CylincamDefinitionChoosePop extends PopupWindow {
    ...
    public interface OnItemSelectedListener {
        void onItemSelected(CylincamDefinitionBean bean);
    }

    public CylincamDefinitionChoosePop(@NonNull Context context, @NonNull OnItemSelectedListener listener) {
        super(context);
    ...
    class DefinitionListAdapter extends BaseAdapter {
        ...
        private List<CylincamDefinitionBean> list = new ArrayList<>();

        public DefinitionListAdapter() {
            list.add(new CylincamDefinitionBean(context,1));
            list.add(new CylincamDefinitionBean(context,2));
            list.add(new CylincamDefinitionBean(context,3));
//            list.add(new CylincamDefinitionBean(0));
        }

        public List<CylincamDefinitionBean> getData() {
            return list;
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        int p = (int) v.getTag();
                        CylincamDefinitionBean bean = list.get(p);
            ...
            CylincamDefinitionBean bean = list.get(position);
