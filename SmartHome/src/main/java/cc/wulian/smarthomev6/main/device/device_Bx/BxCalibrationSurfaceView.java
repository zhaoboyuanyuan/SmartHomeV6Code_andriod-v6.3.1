...
public class BxCalibrationSurfaceView extends LinearLayout implements IDeviceMore {

    private static String TAG = BxCalibrationSurfaceView.class.getSimpleName();
    ...
    public BxCalibrationSurfaceView(Context context) {
        super(context);
        ...
        EndpointParser.parse(device, new EndpointParser.ParserCallback() {
            ...
            public void onFindAttribute(Endpoint endpoint, Cluster cluster, Attribute attribute) {
                if (cluster.clusterId == 0x0201) {
                    if (attribute.attributeId == 0x800D) {
                        try {
