 ...
 */
function globalLang() {
	window.device_B9_name = languageUtil.getResource("device_B9_name")
	window.device_B9_Offline = languageUtil.getResource("device_B9_Offline") //设备已离线
	window.lang_Log 	= languageUtil.getResource("Balanec_45_log");
    window.device_B9_way_in 	= languageUtil.getResource("device_B9_way_in");
    window.device_B9_way_out 	= languageUtil.getResource("device_B9_way_out");
    window.device_B9_fortifying 	= languageUtil.getResource("device_B9_fortifying");
    window.device_B9_disarming 	= languageUtil.getResource("device_B9_disarming");
    window.device_B9_disarmed 	= languageUtil.getResource("device_B9_disarmed");
    window.device_B9_fortify 	= languageUtil.getResource("device_B9_fortify");
    window.device_B9_abnormal 	= languageUtil.getResource("device_B9_abnormal");
    window.device_B9_normal 	= languageUtil.getResource("device_B9_normal");
    window.device_name_B9 	= languageUtil.getResource("device_name_B9");
    window.device_B9_sent 	= languageUtil.getResource("device_B9_sent");
    window.device_B9_enter_name 	= languageUtil.getResource("device_B9_enter_name");
    window.device_B9_s 	= languageUtil.getResource("device_B9_s");
    window.device_B9_cancel 	= languageUtil.getResource("device_B9_cancel");
    window.device_B9_ok 	= languageUtil.getResource("device_B9_ok");
    window.device_B9_noData 	= languageUtil.getResource("device_B9_noData");

    window.device_B9_re_edit 	= languageUtil.getResource("device_B9_re_edit");
    window.device_B9_delete 	= languageUtil.getResource("device_B9_delete");
    window.device_B9_add_button 	= languageUtil.getResource("device_B9_add_button");

    window.device_B9_action_close 	= languageUtil.getResource("device_B9_action_close");
    window.device_B9_action_open 	= languageUtil.getResource("device_B9_action_open");
    window.device_B9_action_open_close 	= languageUtil.getResource("device_B9_action_open_close");
    window.device_B9_action_close_open 	= languageUtil.getResource("device_B9_action_close_open");

    window.device_B9_close_time 	= languageUtil.getResource("device_B9_close_time");
    window.device_B9_open_time 	= languageUtil.getResource("device_B9_open_time");
