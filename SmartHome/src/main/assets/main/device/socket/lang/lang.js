 ...
 */
function globalLang() {
    window.lang_socket_01 = languageUtil.getResource("socket_01")
    window.lang_socket_open = languageUtil.getResource("socket_open")
    window.lang_socket_close = languageUtil.getResource("socket_close")
