...
public class DevBnCallToAnswerActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_devbn_calltoanswer);
        mOptions = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.camera_default_bg3)
                .cacheInMemory(true)
                .cacheOnDisk(true)
    ...
    public static void start(Context context, String destID, String pictureURL, String cameraId, String bucket, String region) {
        Intent intent = new Intent(context, DevBnCallToAnswerActivity.class);
    ...
    private void delayGetImage() {
        if (!StringUtil.isNullOrEmpty(pictureUrl)) {
            TimerTask task = new TimerTask() {
                public void run() {
                    DevBnCallToAnswerActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.txtAnswer: {
                ...
                if (device != null) {
                    DeviceBnCameraActivity.start(DevBnCallToAnswerActivity.this, device.devID, cameraId, true);
                    finish();
                }
            }
            break;
    ...
    ImageLoadingListener listener = new ImageLoadingListener() {
        ...
        public void onLoadingCancelled(String imageUri, View view) {
            iv_bg.setImageResource(R.drawable.camera_default_bg3);
        }
    };
