...
function initlan() {
	var languageCode = getLang();//window.sysfun.getLang();
 ...
 */
function globalLang() {
    window.device_Bt_name = languageUtil.getResource("device_Bt_name")
    window.lang_socket_open = languageUtil.getResource("device_Bw_on")
    window.lang_socket_close = languageUtil.getResource("device_Bw_off")
    window.lang_Alarm = languageUtil.getResource("Alarm")
    window.lang_Log = languageUtil.getResource("Log")
    window.lang_bt_control = languageUtil.getResource("device_Bw_control")
}
