 ...
 */
function globalLang() {
    window.device_name_A1 = languageUtil.getResource("device_safety_a1_name")
    window.top_fortify = languageUtil.getResource("fortifying")
    window.top_disarm = languageUtil.getResource("disarmed")
    window.bottom_fortify = languageUtil.getResource("fortify")
    window.bottom_disarm = languageUtil.getResource("disarming")
    window.alarm_left = languageUtil.getResource("Device_text_01")
    window.alarm_right = languageUtil.getResource("Device_text_02")
    window.alarm_normal = languageUtil.getResource("Device_text_03")
    window.alarm = languageUtil.getResource("Device_text_04")
    window.yesterday = languageUtil.getResource("Device_text_05")
