    ...
    public void sortByMethod(List<E> list, final String method,
        ...
        Collections.sort(list, new Comparator<Object>() {
            ...
            public int compare(Object arg1, Object arg2) {
                int result = 0;
                try {
                    Method m1 = ((E) arg1).getClass().getMethod(method);
                    Method m2 = ((E) arg2).getClass().getMethod(method);
                    Object obj1 = m1.invoke(((E) arg1));
                    Object obj2 = m2.invoke(((E) arg2));
                    if (obj1 instanceof String) {
                        // 字符串
                        result = Trans2PinYin
                                .trans2PinYin(obj1.toString().trim())
                                .toLowerCase()
                                .compareTo(
                                        Trans2PinYin.trans2PinYin(obj2.toString())
                                                .toLowerCase());
                        ...
                        System.err.println("SortUtil.sortByMethod方法接受到不可识别的对象类型，转换为字符串后比较返回...");
                    }
