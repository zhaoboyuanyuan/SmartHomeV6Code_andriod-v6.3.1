...
public class ImageCycleView extends LinearLayout {
	 ...
	 */
	public void setImageResources(ArrayList<AdvertisementEntity> infoList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
		mGroup.removeAllViews();
		// 图片广告数量
		int imageCount = infoList.size();
...
//			mImageView.setPadding(imagePadding, imagePadding, imagePadding, imagePadding);
	...
	private class ImageCycleAdapter extends PagerAdapter {
		 ...
		 * 图片资源列表
		 */
		private ArrayList<AdvertisementEntity> mAdList = new ArrayList<AdvertisementEntity>();
		...
		public ImageCycleAdapter(Context context, ArrayList<AdvertisementEntity> adList, ImageCycleViewListener imageCycleViewListener) {
			mContext = context;
			mAdList = adList;
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			...
			String resId = mAdList.get(position).getRes();
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(AdvertisementEntity info, int postion, View imageView);
	}
