 ...
 * Function: 触摸调光开关 首页widget
 */

public class HomeWidget_Av_RegulateSwitch extends RelativeLayout implements IWidgetLifeCycle, View.OnClickListener {

    private static final String TAG = HomeWidget_Av_RegulateSwitch.class.getSimpleName();
    private Context mContext;
    private TextView tv_name, tv_sate, tv_room;
    private RegulateSwitch regulate_switch;
    private Device mDevice;

    public HomeWidget_Av_RegulateSwitch(Context context) {
        super(context);
        mContext = context;
        initView(context);
    }

    public HomeWidget_Av_RegulateSwitch(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView(context);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.root_view:
                RegulateSwitchAvActivity.start(mContext, mDevice.devID);
                break;
        }
    }
