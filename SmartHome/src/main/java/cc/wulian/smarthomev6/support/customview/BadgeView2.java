...
/**
 * links: https://github.com/stefanjauker/BadgeView2
 */
public class BadgeView2 extends android.support.v7.widget.AppCompatTextView {
    ...
    private void init() {
        ...
        setBackground(9, Color.parseColor("#F77E25"));
    ...
    /*
     * Attach the BadgeView2 to the TabWidget
     * 
     * @param target the TabWidget to attach the BadgeView2
     * 
    ...
    /*
     * Attach the BadgeView2 to the target view
     * 
     * @param target the view to attach the BadgeView2
     */
    public void setTargetView(View target) {
        ...
        if (target.getParent() instanceof FrameLayout) {
            ...
            WLog.e(getClass().getSimpleName(), "ParentView is needed");
        }
