...
public class DevBnInputWifiFragment extends WLFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private DevBnCheckBindFragment bindWaitFragment;
    ...
    public static DevBnInputWifiFragment newInstance(String gwId, String devId, boolean isAddDevice) {
        Bundle bundle = new Bundle();
        bundle.putString("gwID", gwId);
        bundle.putString("devID", devId);
        bundle.putBoolean("isAddDevice", isAddDevice);
        DevBnInputWifiFragment inputWifiFragment = new DevBnInputWifiFragment();
        ...
        if (id == R.id.btn_next_step) {
            if (scanResult != null) {
                ...
                if (wifiPassword.length() < 8 && !cbNoWiFiPwd.isChecked()) {
                    ...
                    bindWaitFragment = DevBnCheckBindFragment.newInstance(devId, gwId, configData);
                    ft.replace(android.R.id.content, bindWaitFragment, bindWaitFragment.getClass().getName());
