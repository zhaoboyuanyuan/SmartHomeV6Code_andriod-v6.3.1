...
//            scale = Math.min(scaleWidth, scaleHeight);
    ...
    public static float sp2px(float sp) {
        final float scale = MainApplication.getApplication().getResources().getDisplayMetrics().scaledDensity;
        return sp * scale;
    }


    public static int getScreenWidth() {
        return MainApplication.getApplication().getResources().getDisplayMetrics().widthPixels;
    }

    public static int getScreenHeight() {
        return MainApplication.getApplication().getResources().getDisplayMetrics().heightPixels;
    }
    /**
     * 设置View的PX尺寸
     *
