 ...
 * 机顶盒遥控主界面（控制和学习）
 */
public class StbRemoteMainActivity extends BaseTitleActivity {
    ...
    public static void startForScene(Activity context, String deviceID, String blockType, String blockName, String blockId, String codeLib) {
        Intent intent = new Intent(context, StbRemoteMainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_if01_stb_main, true);
    }
        ...
        if (TextUtils.equals(mode, WifiIRManage.MODE_CONTROL)) {
            if (isSceneOrHouseKeeper) {
                if (TextUtils.isEmpty(blockName)) {
                    if (TextUtils.equals(blockType, WifiIRManage.TYPE_STB)) {
                        setToolBarTitle(WifiIRManage.getDeviceTypeName(this, WifiIRManage.TYPE_STB));
                    }
                } else {
                ...
                if (TextUtils.isEmpty(blockName)) {
                    if (TextUtils.equals(blockType, WifiIRManage.TYPE_STB)) {
                        setToolBarTitleAndRightImg(WifiIRManage.getDeviceTypeName(this, WifiIRManage.TYPE_STB), R.drawable.icon_more);
                    }
                } else {
