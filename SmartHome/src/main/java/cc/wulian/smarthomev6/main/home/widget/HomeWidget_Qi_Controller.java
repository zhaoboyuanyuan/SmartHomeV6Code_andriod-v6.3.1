 ...
 * Function: 5038空调温控器 首页widget
 */

public class HomeWidget_Qi_Controller extends RelativeLayout implements IWidgetLifeCycle, View.OnClickListener {

    private static final String TAG = HomeWidget_Qi_Controller.class.getSimpleName();
    ...
    public HomeWidget_Qi_Controller(Context context) {
        super(context);
        mContext = context;
        initView(context);
    }

    public HomeWidget_Qi_Controller(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView(context);
    }
    ...
    private void initView(Context context) {
        final View rootView = LayoutInflater.from(context).inflate(R.layout.view_home_oi_controller, null);
    ...
    private int getResByType(int mode) {
        ...
        switch (mode) {
            case 1:
                modeRes = R.string.Device_Widget_Oi_Type_Cold;
                break;
            case 2:
                modeRes = R.string.Device_Widget_Oi_Type_Heat;
                break;
            case 3:
