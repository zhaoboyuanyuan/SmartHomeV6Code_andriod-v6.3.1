 ...
 */
function globalLang() {
    window.lang_name_A5 = languageUtil.getResource("device_A5_name")//"门铃按钮02型"
    window.lang_normal = languageUtil.getResource("DoorbellButton_normal")//"正常"
    window.lang_Log = languageUtil.getResource("Log")//"日志"
    window.lang_Alarm = languageUtil.getResource("Alarm")//"报警消息"
    window.lang_OnLine = languageUtil.getResource("DoorbellButton_onLine")//"在线"
    window.lang_OffLine = languageUtil.getResource("DoorbellButton_offLine")//"离线"
    window.lang_ring = languageUtil.getResource("DoorbellButton_ring")//"有人按门铃"
    window.lang_fortifying = languageUtil.getResource("fortifying")//"设防中"
    window.lang_fortify = languageUtil.getResource("fortify")//"设防"
    window.lang_disarming = languageUtil.getResource("disarming")//"撤防"
    window.lang_disarmed = languageUtil.getResource("disarmed")//"已撤防"
}
