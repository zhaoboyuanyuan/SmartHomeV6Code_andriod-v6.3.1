 ...
 * Function: 墙面插座首页widget
 */

public class HomeWidget_50_Socket extends RelativeLayout implements IWidgetLifeCycle, View.OnClickListener {

    private static final String TAG = HomeWidget_50_Socket.class.getSimpleName();
    ...
    public HomeWidget_50_Socket(Context context) {
        super(context);
        mContext = context;
        initView(context);
    }

    public HomeWidget_50_Socket(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView(context);
    }
    ...
    private void initView(Context context) {
        final View rootView = LayoutInflater.from(context).inflate(R.layout.view_home_50_socket, null);
    ...
    private void updateSwitchState(String state) {
        ...
        switch (state) {
            case "0":
                ...
                state_text.setText(R.string.Device_switch_Widget_Off);
                break;
            case "1":
                openState = 1;
                ...
                state_text.setText(R.string.Device_switch_Widget_On);
                break;
        }
