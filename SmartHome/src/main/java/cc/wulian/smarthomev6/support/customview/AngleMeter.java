...
public class AngleMeter extends View {
    ...
    private int pointer_r;
    private String maxAngle = "110°";
    ...
    private void init(Context context) {
        ...
        pointer_r = DisplayUtil.dip2Pix(context, 4);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 右边的文本
        canvas.drawText(maxAngle, rightCirclePointX + paddingLeftOrRight / 4,
                rightCirclePointY + paddingTop / 2, paint);

        // 画指示点
        paint.setStyle(Paint.Style.FILL_AND_STROKE);
        canvas.drawCircle(pointerX, pointerY, pointer_r, paint);
