 ...
 */
function globalLang() {
	window.lang_device_name	= languageUtil.getResource("device_name_title");
	window.lang_DoDefense = languageUtil.getResource("fortify");
	window.lang_InDefense = languageUtil.getResource("fortifying");
	window.lang_UnDefense = languageUtil.getResource("disarming");
	window.lang_OutOfDefense = languageUtil.getResource("disarmed");
	window.lang_IsNormal = languageUtil.getResource("device_more_isnomormal");
	window.lang_SomeoneAfter = languageUtil.getResource("device_txt_01");
	window.lang_OffLine = languageUtil.getResource("offLine");//"设备已离线"
	window.lang_Yesterday = languageUtil.getResource("device_more_yesterday");
    window.lang_hour = languageUtil.getResource("Dust_hour");//"时"
    window.lang_temperature = languageUtil.getResource("device_content_01"); //"温度";
    window.lang_humidity = languageUtil.getResource("device_content_02"); //"湿度";
    window.lang_light_intensity = languageUtil.getResource("device_content_03"); //"光强";
    window.lang_strong = languageUtil.getResource("device_level_01"); //"光照强";
    window.lang_normal = languageUtil.getResource("device_level_02"); //"光照适宜";
    window.lang_weak = languageUtil.getResource("device_level_03"); //"光照弱";
    window.lang_history_title = languageUtil.getResource("device_title_01"); //"最近二十四个小时数据记录";
    window.lang_Log = languageUtil.getResource("device_more_log");
    window.lang_Alarm = languageUtil.getResource("device_more_alarm");
}
