 ...
 */
function globalLang() {
    window.device_90_name = languageUtil.getResource("device_name_90");
    window.LEDlight_90_colour = languageUtil.getResource("LEDlight_90_colour");
    window.LEDlight_90_Colorful = languageUtil.getResource("LEDlight_90_Colorful");
    window.LEDlight_90_sunlight = languageUtil.getResource("LEDlight_90_sunlight");
    window.LEDlight_90_brightness = languageUtil.getResource("LEDlight_90_brightness");
    window.LEDlight_90_set_time =  languageUtil.getResource("LEDlight_90_set_time");
    window.LEDlight_90_ok = languageUtil.getResource("LEDlight_90_ok");
    window.LEDlight_90_Cancel = languageUtil.getResource("LEDlight_90_Cancel");
	window.LEDlight_90_s = languageUtil.getResource("LEDlight_90_s");
    window.LEDlight_90_ms = languageUtil.getResource("LEDlight_90_ms");
}
