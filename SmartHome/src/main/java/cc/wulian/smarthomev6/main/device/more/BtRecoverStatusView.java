...
public class BtRecoverStatusView extends FrameLayout implements IDeviceMore, CompoundButton.OnCheckedChangeListener {
    ...
    public BtRecoverStatusView(Context context, String deviceID, String gwID) {
        super(context);
        ...
        EndpointParser.parse(device, new EndpointParser.ParserCallback() {
            ...
            public void onFindAttribute(Endpoint endpoint, Cluster cluster, Attribute attribute) {
                if (cluster.clusterId == 0x0006) {
                    if (attribute.attributeId == 0x0006) {
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
        switch (compoundButton.getId()) {
            case R.id.tb_recover_status:
                ...
                sendCmd(0x06, isChecked ? AI_RECOVER_KEEP : AI_RECOVER_CLOSE);
