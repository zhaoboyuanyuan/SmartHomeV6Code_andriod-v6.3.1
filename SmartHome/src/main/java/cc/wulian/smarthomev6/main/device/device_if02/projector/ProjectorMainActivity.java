package cc.wulian.smarthomev6.main.device.device_if02.projector;
 ...
 * 投影仪遥控主界面（控制和学习）
 */
public class ProjectorMainActivity extends BaseTitleActivity {

    private FrameLayout contentLayout;
    private RemoteControlView tvCenterControlView;
    private CheckBox btnCustom;
    ...
    public static void startForScene(Activity context, String deviceID, String blockType, String blockName, String blockId, String codeLib) {
        Intent intent = new Intent(context, ProjectorMainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_if01_projector_main, true);
    }
    ...
    protected void initView() {
        ...
        btnCustom = (CheckBox) findViewById(R.id.btn_custom);
    ...
    protected void initListeners() {
        ...
        btnCustom.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    btnCustom.setText("");
                    btnCustom.setBackgroundResource(R.drawable.infrared_fan_drop);
                } else {
                    layoutMainView.setVisibility(View.VISIBLE);
                    layoutCustomView.setVisibility(View.GONE);
                    btnCustom.setText(R.string.IF_052);
                    btnCustom.setBackgroundResource(R.drawable.infrared_fan_more);
                }
            }
        });
    ...
    public void loadAllKeys() {
        if (keys != null && keys.size() != 0) {
            controllerViewHelper.convertProjectorKeyToItem(keys);
            if (isCustomRemote()) {
    ...
    private void upDateCenterKeys() {
        tvCenterControlView.updateViews(controllerViewHelper.getKeyByTag(AREA_LEFT) == null ? false : true,
                controllerViewHelper.getKeyByTag(AREA_TOP) == null ? false : true,
                controllerViewHelper.getKeyByTag(AREA_RIGHT) == null ? false : true,
                controllerViewHelper.getKeyByTag(AREA_BOTTOM) == null ? false : true,
                controllerViewHelper.getKeyByTag(AREA_CENTER) == null ? false : true);
    }

    //加载自定义按键视图
    private void loadCustomKeys() {
        list = controllerViewHelper.getProjectorCustomKeys();
