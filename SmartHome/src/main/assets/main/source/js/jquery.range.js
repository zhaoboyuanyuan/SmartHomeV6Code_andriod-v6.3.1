...
(function($, window, document, undefined) {
    ...
    jRange.prototype = {
        ...
        template: '<div class="slider-container">\
            ...
            <div class="leftSun sun"></div>\
            <div class="rightSun sun"></div>\
            <div class="scale"></div>\
		</div>',
        ...
        setInputValue: function(pointer, v) {
            ...
            if (this.inputNode.val() !== this.options.value) {
                ...
                var idStr = (this.options.value === "0") ? this.inputNode.attr("data-id") +"_000" : this.inputNode.attr("data-id") +"_" + this.options.value;
                this.inputNode.attr("id",idStr);
