...
public class HomeWidget_CMICA5_Outdoor extends RelativeLayout implements IWidgetLifeCycle {
    ...
    public HomeWidget_CMICA5_Outdoor(Context context) {
        super(context);
        initView(context);
    }
    ...
    private void initView(final Context context) {
        View rootView = LayoutInflater.from(context).inflate(R.layout.view_home_cmica5_outdoor, null);
        ...
        rootView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                OutdoorDetailActivity.start(context, mDevice,false);
            }
        });
    }
