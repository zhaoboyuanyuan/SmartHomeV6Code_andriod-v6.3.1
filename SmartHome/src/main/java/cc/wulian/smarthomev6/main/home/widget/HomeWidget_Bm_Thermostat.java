 ...
 * Tel: 18365264930
 * QQ: 2355738466
 * Function: 罗格朗地暖 首页widget
 */

public class HomeWidget_Bm_Thermostat extends RelativeLayout implements IWidgetLifeCycle, View.OnClickListener {

    private static final String TAG = HomeWidget_Bm_Thermostat.class.getSimpleName();
    ...
    public HomeWidget_Bm_Thermostat(Context context) {
        super(context);

        initView(context);
    }

    public HomeWidget_Bm_Thermostat(Context context, AttributeSet attrs) {
