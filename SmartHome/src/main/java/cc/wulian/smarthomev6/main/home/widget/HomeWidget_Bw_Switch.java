...
public class HomeWidget_Bw_Switch extends RelativeLayout implements IWidgetLifeCycle, View.OnClickListener {
    ...
    public HomeWidget_Bw_Switch(@NonNull Context context) {
        super(context);
        mContext = context;
    ...
    public HomeWidget_Bw_Switch(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView(context);
        initListener();
