 ...
 */
function globalLang() {
    window.device_Bw_name = languageUtil.getResource("device_B_name")
    ...
    window.lang_unBind = languageUtil.getResource("device_Bu_Untied")
    window.lang_time_out = languageUtil.getResource("device_Bu_time_out")
    window.lang_Untied_success = languageUtil.getResource("device_Bu_Untied_success")
    window.lang_Binding_success = languageUtil.getResource("device_Bu_Binding_success");
    ...
    window.lang_device_rename = languageUtil.getResource("device_Bu_Rename");
    window.lang_device_input_name = languageUtil.getResource("device_Bu_enter_name");
    window.lang_device_cancal = languageUtil.getResource("device_Bu_Cancel");
    window.lang_device_sure = languageUtil.getResource("device_Bu_Confirm");
    ...
    window.switch_Ao_Saving = languageUtil.getResource("switch_Ao_Saving") //正在保存
    ...
    window.switch_Bw_ChangeMode02 = languageUtil.getResource("switch_Bu_ChangeMode02") //切换后原有已绑定设备将解除绑定
    window.switch_Bw_ChangeMode03 = languageUtil.getResource("switch_Bu_ChangeMode03") //切换后原有已绑定场景将解除绑定
