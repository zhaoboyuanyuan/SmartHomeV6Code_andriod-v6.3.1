 ...
 */
function globalLang() {
    window.device_Bk_name = languageUtil.getResource("Device_Bk_details_name")
    window.device_sleep_unBind = languageUtil.getResource("Device_Bk_sleep_Unbound")
    window.device_getup_unBind = languageUtil.getResource("Device_Bk_getup_Unbound")
    window.device_sleep_bind = languageUtil.getResource("Device_Bk_sleep_Bound")
    window.device_getup_bind = languageUtil.getResource("Device_Bk_getup_Bound")
