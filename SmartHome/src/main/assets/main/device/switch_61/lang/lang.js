 ...
 */
function globalLang() {
    window.lang_socket_01 = languageUtil.getResource("device_61_Title")
    window.lang_socket_open = languageUtil.getResource("device_61_Alreadyopen")
    window.lang_socket_close = languageUtil.getResource("device_61_Closed")
