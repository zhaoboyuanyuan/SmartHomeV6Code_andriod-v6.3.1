...
function globalLang() {
	...
	window.alarm_txt_05 = languageUtil.getResource("lang_op_isSaveing") //"保存成功"
	...
	window.account = languageUtil.getResource("lang_account") //"账号管理"
	window.sms = languageUtil.getResource("lang_sms") //"开门记录"
	window.alarm = languageUtil.getResource("lang_alarm") //"报警消息"
	window.setAlarm = languageUtil.getResource("lang_setAlarm") //"报警设置"
    ...
    window.device_op_send_content_1 = languageUtil.getResource("DoorLook_More_Send_content_1");
    window.device_op_send_content_2 = languageUtil.getResource("DoorLook_More_Send_content_2");
    window.device_op_send_content_3 = languageUtil.getResource("DoorLook_More_Send_content_3");
    window.device_op_send_content_4 = languageUtil.getResource("DoorLook_More_Send_content_4");
    window.device_op_normal = languageUtil.getResource("device_op_normal_01");
    window.device_op_once = languageUtil.getResource("device_op_once_01");
    window.device_op_temp = languageUtil.getResource("device_op_temp_01");
