...
function globalLang() {
    ...
    window.device_19_name = languageUtil.getResource("device_19_Details_Name")//"移动插座计量版"
    window.lang_weak = languageUtil.getResource("device_19_Details_weak");
    window.lang_strong = languageUtil.getResource("device_19_Details_strong")//"强";
    window.lang_suitable = languageUtil.getResource("device_19_Details_suitable")//"适宜";
    window.lang_weak2 = languageUtil.getResource("device_19_Details_weak2")//"光照弱";
    window.lang_strong2 = languageUtil.getResource("device_19_Details_strong2")//"光照强";
    window.lang_suitable2 = languageUtil.getResource("device_19_Details_suitable2")//"光照适宜";
    window.lang_lx = languageUtil.getResource("device_19_Details_lx")//"当前光照强度";
    window.lang_record = languageUtil.getResource("device_19_Details_record")//"最近24小时记录";
    window.lang_record2 = languageUtil.getResource("device_19_Details_record2")//"时";
}
