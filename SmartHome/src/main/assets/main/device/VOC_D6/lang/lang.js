 ...
 */
function globalLang() {
    window.title_name = languageUtil.getResource("device_D6_name");
    ...
    window.device_tip_1 = languageUtil.getResource("VOC_level_1");
    window.device_tip_2 = languageUtil.getResource("VOC_level_2");
    window.device_tip_3 = languageUtil.getResource("VOC_level_3");
    window.lang_hour = languageUtil.getResource("VOC_Statistics_h");
}
