...
function globalLang() {
    //门锁名称
    window.device_69_name = languageUtil.getResource("device_name_69");//""
    window.device_70_name = languageUtil.getResource("device_name_70");//
    window.device_Bc_name = languageUtil.getResource("device_name_Bc");//
    window.device_Bf_name = languageUtil.getResource("device_name_Bf");//
    window.device_Bn_name = languageUtil.getResource("device_name_Bn");//
    window.device_Bq_name = languageUtil.getResource("device_name_Bq");//
    window.device_Bg_name = languageUtil.getResource("device_name_Bg");//
    window.device_OW_name = languageUtil.getResource("device_name_OW");//
    window.device_OP_name = languageUtil.getResource("device_name_OP");//
    window.device_overtime = languageUtil.getResource("lang_txt_24");//请求超时，请重试
    window.device_unBind = languageUtil.getResource("device_38_unband");//未绑定
    window.lang_group = languageUtil.getResource("device_38_unband");//未分区
    window.lang_offLine = languageUtil.getResource("offLine_1");//离线
    window.lang_onLine = languageUtil.getResource("onLine");//在线
    window.lang_alarm = languageUtil.getResource("lang_alarm");//在线
    window.device_38_name = languageUtil.getResource("device_38_name");//在线
}
