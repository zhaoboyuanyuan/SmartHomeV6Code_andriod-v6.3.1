...
public class OutdoorProtectSettingActivity extends BaseTitleActivity implements IcamMsgEventHandler, View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoor_protect_setting, true);
        ...
        switch (v.getId()) {
            ...
            case R.id.rl_protect_time:
                startActivityForResult(
                        (new Intent(this, OutdoorProtectTimeActivity.class)).putExtra(
                                "time", spMoveTime).putExtra("weekday",
                                spMoveWeekday), REQUESTCODE_MOVE_TIME);
                break;
            case R.id.rl_protect_area:
                startActivityForResult(
                        (new Intent(this, OutdoorProtectAreaActivity.class))
