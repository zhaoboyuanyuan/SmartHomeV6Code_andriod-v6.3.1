...
public class OutdoorRecordStorageActivity extends BaseTitleActivity implements IcamMsgEventHandler {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoor_record_storage, true);
                ...
                formatDialog = DialogUtil.showCommonDialog(this,
                        ...
                        new WLDialog.MessageListener() {
                            ...
                            public void onClickPositive(View var1, String msg) {
                                ...
                                progressDialogManager.showDialog(FORMAT, OutdoorRecordStorageActivity.this, getResources().getString(R.string.Formatting), null);
                            }
