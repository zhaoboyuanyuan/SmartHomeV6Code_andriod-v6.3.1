package cc.wulian.smarthomev6.main.device.camera_lc.business;

import android.os.Bundle;
import android.os.Handler;
import android.util.Log;

import cc.wulian.smarthomev6.main.device.camera_lc.business.entity.AlarmMessageInfo;
import cc.wulian.smarthomev6.main.device.camera_lc.business.entity.ChannelInfo;
import cc.wulian.smarthomev6.main.device.camera_lc.business.entity.ChannelPTZInfo;
import cc.wulian.smarthomev6.main.device.camera_lc.business.entity.ChannelPTZInfo.Direction;
import cc.wulian.smarthomev6.main.device.camera_lc.business.entity.ChannelPTZInfo.Duration;
import cc.wulian.smarthomev6.main.device.camera_lc.business.entity.ChannelPTZInfo.Operation;
import cc.wulian.smarthomev6.main.device.camera_lc.business.entity.RecordInfo;
import cc.wulian.smarthomev6.main.device.camera_lc.business.entity.RecordInfo.RecordEventType;
import cc.wulian.smarthomev6.main.device.camera_lc.business.entity.RecordInfo.RecordType;
import cc.wulian.smarthomev6.main.device.camera_lc.business.util.OpenApiHelper;
import cc.wulian.smarthomev6.main.device.camera_lc.business.util.TaskPoolHelper;
import cc.wulian.smarthomev6.main.device.camera_lc.business.util.TaskPoolHelper.RunnableTask;
...
//					 handler.obtainMessage(retObject.mErrorCode, ((AccessToken.Response)retObject.resp).data.accessToken).sendToTarget();
     ...
     * 为账号解绑设备
     *
     * @param deleteCloudRecords 是否删除云录像
     * @param deviceID           序列号
     * @param handler
     */
