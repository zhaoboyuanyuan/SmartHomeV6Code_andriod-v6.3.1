 ...
 */
function globalLang() {
	window.Balanec_45_name = languageUtil.getResource("Balanec_45_name") //"智能体重秤"
	window.offline = languageUtil.getResource("offline") //设备已离线
	window.lang_Log 	= languageUtil.getResource("Balanec_45_log");
    window.Balanec_button_1 	= languageUtil.getResource("Balanec_button_1");
    window.Balanec_button_2 	= languageUtil.getResource("Balanec_button_2");
    window.Balanec_45_title 	= languageUtil.getResource("Balanec_45_title");
    window.Balanec_content_2 	= languageUtil.getResource("Balanec_content_2");
    window.Balanec_heading_45 	= languageUtil.getResource("Balanec_heading_45");
    window.Balanec_button_3 	= languageUtil.getResource("Balanec_button_3");
    window.Balanec_content_6 	= languageUtil.getResource("Balanec_content_6");
