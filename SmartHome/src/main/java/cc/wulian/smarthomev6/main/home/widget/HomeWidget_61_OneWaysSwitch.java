...
public class HomeWidget_61_OneWaysSwitch extends FrameLayout implements IWidgetLifeCycle, View.OnClickListener {
    ...
    public HomeWidget_61_OneWaysSwitch(@NonNull Context context) {
        super(context);
        mContext = context;
        initView(context);
    }

    public HomeWidget_61_OneWaysSwitch(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView(context);
    }
    ...
    private void initView(Context context) {
        final View rootView = LayoutInflater.from(context).inflate(R.layout.view_home_61_one_ways_switch, null);
...
//            Log.i("luzx", "onDeviceReport 61:" + mDevice);
//            mDevice = MainApplication.getApplication().getDeviceCache().get(mDevice.devID);
//            dealDevice(mDevice);
        }
    }
