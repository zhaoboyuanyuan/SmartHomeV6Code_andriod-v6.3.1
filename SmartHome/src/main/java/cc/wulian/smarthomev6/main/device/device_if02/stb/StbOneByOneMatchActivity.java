...
public class StbOneByOneMatchActivity extends BaseTitleActivity {
    ...
    private String[] tagArray = {"vol+", "ch+", "ok"};
    ...
    public static void start(Context context, String deviceId, String type, String brandId, String brandName) {
        Intent intent = new Intent(context, StbOneByOneMatchActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stb_one_by_one_match, true);
    }
    ...
    /**
     * 遍历出每一个codeLibs中vol+、ch+、ok按键对应的码
     */
