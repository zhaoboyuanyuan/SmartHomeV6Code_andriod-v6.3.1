...
/**
 * Created by Wulian on 2018/9/6.
 */

public class LoadingAssertView extends View {
    ...
    public LoadingAssertView(Context context) {
        this(context, null);
    }

    public LoadingAssertView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingAssertView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;

        //暂不维护
//        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.LoadingAssertView);
...
//        ta.recycle();
    ...
    private void init() {
        ...
        WLog.d(TAG, "init: mScreenWidth:" + mScreenWidth);
        mScreenHeight = getScreenHeight(mContext);
        WLog.d(TAG, "init: mScreenHeight:" + mScreenHeight);
