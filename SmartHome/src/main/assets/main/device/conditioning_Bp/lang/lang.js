 ...
 */
function globalLang() {
    window.device_Bp_name = languageUtil.getResource("Name")//罗格朗空调
    window.Device_Bp_Host = languageUtil.getResource("Host");//"主机";
    window.Device_Bp_Slave = languageUtil.getResource("Slave");//从机";
    window.Device_Bp_Details_On = languageUtil.getResource("On");//"开机";
    window.Device_Bp_Details_Off = languageUtil.getResource("Off");//"关机";
    ...
    window.Device_Bp_Details_Cancel = languageUtil.getResource("Cancel");//"取消";
    window.Device_Bp_Details_Confirm = languageUtil.getResource("sure");//"确定";
    ...
    window.prompt_Bp = languageUtil.getResource("Device_Bp_Details_Prompt");//"摆动";
    window.abnormal = languageUtil.getResource("abnormal");//"摆动";
    window.i_know = languageUtil.getResource("Add_batches_i_know");//"摆动";
