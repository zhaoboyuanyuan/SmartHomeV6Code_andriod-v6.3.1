 ...
 */
function globalLang() {
    window.title_name = languageUtil.getResource("device_D4_name");
    ...
    window.device_tip_1 = languageUtil.getResource("Noise_level_1");
    window.device_tip_2 = languageUtil.getResource("Noise_level_2");
    window.device_tip_3 = languageUtil.getResource("Noise_level_3");
    window.lang_hour = languageUtil.getResource("Noise_Statistics_h");
}
