 ...
 */
function globalLang() {
	window.device_28_hour = languageUtil.getResource("device_28_hour");//小时
	window.device_28_minute = languageUtil.getResource("device_28_minute");//分钟
	window.device_28_Countdown_open = languageUtil.getResource("device_28_Countdown_open");//倒计时开启
	window.device_28_Countdown_off = languageUtil.getResource("device_28_Countdown_off");//倒计时关闭
	window.device_28_open_after = languageUtil.getResource("device_28_open_after");//后开启
	window.device_28_close_after = languageUtil.getResource("device_28_close_after");//后关闭
	window.device_28_cancel = languageUtil.getResource("device_28_cancel");//取消
	window.device_28_confirm = languageUtil.getResource("device_28_confirm");//确认
	window.device_28_offline = languageUtil.getResource("device_28_offline");//设备已离线
    window.device_28_Sure_to_cancel = languageUtil.getResource("device_28_Sure_to_cancel");//确定取消倒计时
