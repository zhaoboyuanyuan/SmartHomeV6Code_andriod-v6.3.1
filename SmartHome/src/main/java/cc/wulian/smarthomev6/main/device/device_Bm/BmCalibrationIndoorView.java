...
public class BmCalibrationIndoorView extends LinearLayout implements IDeviceMore {

    private static String TAG = BmCalibrationIndoorView.class.getSimpleName();
    ...
    public BmCalibrationIndoorView(Context context) {
        super(context);
            ...
            public void onFindAttribute(Endpoint endpoint, Cluster cluster, Attribute attribute) {
                if (cluster.clusterId == 0x0201) {
                    if (attribute.attributeId == 0x8001) {
                        try {
                            tempIndex = hexStringToTempIndex(attribute.attributeValue.substring(38, 40));
