 ...
 */
function globalLang() {
    window.device_Bl_name = languageUtil.getResource("device_name_Bl");//"遥控器"
    window.device_unBind = languageUtil.getResource("scenario_controller_Unbound");//未绑定
    window.device_overtime = languageUtil.getResource("Bind_Connection_timed_out");//请求超时，请重试
}
