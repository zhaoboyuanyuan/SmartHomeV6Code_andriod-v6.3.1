...
function reloadUI(attributeId,attributeValue,flag){
    switch (attributeId){
        ...
        case 0x8005:{
            //本地开锁模式
            console.log("本地开锁模式")
            //1常开模式、2正常模式、3双重验证、4双用户验证
            switch (attributeValue) {
                case "1":{
                    console.log("本地开锁模式--常开模式")
                }
                break;
                case "2":{
                    console.log("本地开锁模式--正常模式")
                }
                    break;
                case "3":{
                    console.log("本地开锁模式--双重验证")
                }
                    break;
                case "4":{
                    console.log("本地开锁模式--双用户验证")
                }
                    break;
                default:
                    break;
        ...
        case 0x8006:{
            ...
            if(attributeValue.substr(0,1) == "1"){
                ...
                //电量
                if(attributeValue.substr(3,2) == "00"){
        ...
        case 0x8007:{
            if(attributeValue == "1") {
                console.log("门铃按下事件上报")
            } else if(attributeValue == "2") {
                console.log("离家按键事件上报")
            }
        }
            break;
        case 0x8008:{
        ...
        case 0x800A:{
            ...
            break;
        case 0x800B:{
            console.log("本地正常模式开锁")
            if(attributeValue.length == 6) {
                var openway = attributeValue.substr(0,2);
                var openID = attributeValue.sub((2,4))
                hint_txt.html(lang_txt_17)
            } else {
            ...
            break;
        case 0x800C:{
            console.log("本地双重验证开锁")
            if(attributeValue.length == 12) {
                var openway1 = attributeValue.substr(0,2);
                var openID1 = attributeValue.sub((2,4))
                var openway2 = attributeValue.substr(6,2);
                var openID2 = attributeValue.sub((8,4))
                hint_txt.html(lang_txt_17)
            } else {
