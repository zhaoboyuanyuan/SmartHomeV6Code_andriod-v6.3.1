function initlan() {
	try {
		...
		if(iStr == "iphoneX") {
            ...
            var lockImg = document.getElementsByClassName("lockState")
            ...
            document.getElementsByClassName("iphoneX")[0].style.top = "8.8rem";
		}
	} catch(e) {
...
function globalLang() {
    ...
    window.device_Bf_title = languageUtil.getResource("device_Bf_title");//"保存"

    window.device_Bf_alarm_tit = languageUtil.getResource("device_bc_alarm_tit");//"报警设置";
    window.device_Bf_alarm_04 = languageUtil.getResource("device_bc_alarm_04");//"手机开锁";
    window.device_Bf_alarm_05 = languageUtil.getResource("device_bc_alarm_05");//"射频卡开锁";
    window.device_Bf_alarm_06 = languageUtil.getResource("device_bc_alarm_06");//"密码开锁";
    window.device_Bf_alarm_07 = languageUtil.getResource("device_bc_alarm_07");//"指纹开锁";
    window.device_Bf_alarm_08 = languageUtil.getResource("device_bc_alarm_08");//"反锁";
    window.device_Bf_alarm_09 = languageUtil.getResource("device_Bf_alarm_09");//"反锁";
    ...
    window.doorLock_door_is_open = languageUtil.getResource("doorLock_door_is_open");//"门已打开";
    window.doorLock_door_is_closed = languageUtil.getResource("doorLock_door_is_closed");//"门已打开";
    window.doorLock_door_is_noOk = languageUtil.getResource("doorLock_door_is_noOk");//"门已打开";
    window.doorLock_Safety_On = languageUtil.getResource("doorLock_Safety_On");//"上保险";
    window.doorLock_Unlock = languageUtil.getResource("doorLock_Unlock");//"未保险";
    window.doorLock_Double_locked = languageUtil.getResource("doorLock_Double_locked");//"";
    window.doorLock_No_Double_locked = languageUtil.getResource("doorLock_No_Double_locked");//"";
    window.doorLock_Slide_up_unlock = languageUtil.getResource("doorLock_Slide_up_unlock");//"已上锁，上滑解锁";
