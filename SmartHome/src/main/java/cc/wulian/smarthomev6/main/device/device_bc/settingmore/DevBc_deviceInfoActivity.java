 ...
 */
/*关于获取爱看最新版本的说明
* 1.先使用IPCMsgController.MsgQueryFirewareVersion获取当前的内部版本号，记为deviceVersionCode；
* 2.使用[1]中获取的参数，调用RouteApiType.V3_VERSION_STABLE，然后再获取一个版本号，然后对比，若deviceVersionCode比较小，则说明有新版本
* */
public class DevBc_deviceInfoActivity extends BaseTitleActivity implements IcamMsgEventHandler {
    private ICamApiUnit iCamApiUnit;
    private TextView devCamaraNum;
    private TextView devCamaraVersion;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_devbc_usermanager, true);
    ...
    protected void initView() {
        super.initView();
        devCamaraNum = (TextView) findViewById(R.id.devCamaraNum);
        devCamaraVersion = (TextView) findViewById(R.id.devCamaraVersion);
                    ...
                    if (attributeId == 0x8007) {
                        ...
                        if (TextUtils.equals(preFlag, "07")) {
                            ...
                            if (splitVersion != null && splitVersion.length == 3) {
                                ...
                                devCamaraVersion.setText(splitVersion[2]);//摄像机固件版本
    ...
    private void getCameraIdByCloud() {
        ...
        dataApiUnit.doGetBcCameraId(devID,"Bc", new DataApiUnit.DataApiCommonListener<String>() {
            @Override
            public void onSuccess(String bean) {
                if (!TextUtils.isEmpty(bean)) {
                    cameraId = bean;
                    devCamaraNum.setText(cameraId);
                }
            }
