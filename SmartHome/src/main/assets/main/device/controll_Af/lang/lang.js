 ...
 */
function globalLang() {
    window.lang_name_Af = languageUtil.getResource("Af_name");//"Af";
    ...
    window.lang_Details_Type3 = languageUtil.getResource("Mode_Switch_03");//"送风";
    ...
    window.lang_device_Ol_ok = languageUtil.getResource("Mode_Switch_09");//"确定";

    window.lang_Remind = languageUtil.getResource("Remind");//"过滤提醒";

    window.lang_Mode_Cool = languageUtil.getResource("Mode_Cool");//"Mode_Cool";
    window.lang_Mode_Hot = languageUtil.getResource("Mode_Hot");//"Mode_Hot";
}
