...
public class HomeWidget_Co_MetalCurtain extends RelativeLayout implements IWidgetLifeCycle, View.OnClickListener {
    ...
    public HomeWidget_Co_MetalCurtain(Context context) {
        super(context);
