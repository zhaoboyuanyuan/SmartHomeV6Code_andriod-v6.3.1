 ...
 */
function globalLang() {
    window.device_Bw_name = languageUtil.getResource("device_Bv_name")
    window.device_Bw_on = languageUtil.getResource("device_Bv_on")
    window.device_Bw_off = languageUtil.getResource("device_Bv_off")
    window.device_Bw_control = languageUtil.getResource("device_Bv_control")
    window.device_Bw_Rename = languageUtil.getResource("device_Bv_Rename")
    window.device_Bw_enter_name = languageUtil.getResource("device_Bv_enter_name")
    ...
    window.lang_unBind = languageUtil.getResource("device_Bv_Untied")
    window.lang_time_out = languageUtil.getResource("device_Bv_time_out")
    window.lang_Untied_success = languageUtil.getResource("device_Bv_Untied_success")
    window.lang_Binding_success = languageUtil.getResource("device_Bv_Binding_success");
    ...
    window.lang_device_rename = languageUtil.getResource("device_Bv_Rename");
    window.lang_device_input_name = languageUtil.getResource("device_Bv_enter_name");
    window.lang_device_cancal = languageUtil.getResource("device_Bv_Cancel");
    window.lang_device_sure = languageUtil.getResource("device_Bv_Confirm");
    ...
    window.device_Bw_Binding = languageUtil.getResource("device_Bv_Binding") // 正在绑定，请稍后...
    window.device_Bw_Binding_failure = languageUtil.getResource("device_Bv_Binding_failure") // 绑定失败，请重试
    ...
    window.switch_Bw_ChangeMode02 = languageUtil.getResource("switch_Bv_ChangeMode02") //切换后原有已绑定设备将解除绑定
    window.switch_Bw_ChangeMode03 = languageUtil.getResource("switch_Bv_ChangeMode03") //切换后原有已绑定场景将解除绑定
