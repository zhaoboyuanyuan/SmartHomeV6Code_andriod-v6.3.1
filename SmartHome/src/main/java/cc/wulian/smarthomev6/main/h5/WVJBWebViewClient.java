...
public class WVJBWebViewClient extends WebViewClient {
    ...
    private static final String kInterface = TAG + "Interface";
        ...
        executeJavascript(script, new JavascriptCallback() {
            public void onReceiveValue(String messageQueueString) {
                if (messageQueueString == null
                    ...
                    return;
                try {
                    processQueueMessage(URLDecoder.decode(messageQueueString,"utf-8"));
    ...
    private void processQueueMessage(String messageQueueString) {
        try {
//            messageQueueString = messageQueueString.replaceAll("u003C", "<");
    ...
    void log(String action, Object json) {
        ...
        if (jsonString.length() > 500) {
            WLog.i(TAG, action + ": " + jsonString.substring(0, 500) + " [...]");
        } else {
            WLog.i(TAG, action + ": " + jsonString);
        }
    }
    ...
    private class MyJavascriptInterface {
        ...
        public void onResultForScript(String key, String value) {
            WLog.i(TAG, "onResultForScript: " + value);
