 ...
 * 扫码界面
 */
public final class HisQRCodeActivity extends BaseTitleActivity implements SurfaceHolder.Callback, ICaptureActivity {

    private static final String TAG = HisQRCodeActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_his_qrcode, true);
    ...
    public void onClick(View v) {
        super.onClick(v);
        if (v == layout_input) {
            Intent intent = new Intent(this, AddHisDevByUidActivity.class);
            intent.putExtra("hisType",hisType);
...
//        }
    ...
    public void handleDecode(Result rawResult, Bundle bundle) {
        ...
        startActivity(new Intent(this, HisDevStartConfigActivity.class)
                .putExtra("deviceId", deviceId)
                .putExtra("hisType", hisType)
