 ...
 */
function globalLang() {
    window.addDevice_D7_name = languageUtil.getResource("device_D7_name");
    window.lang_D7_color = languageUtil.getResource("colour");
    window.lang_D7_brightness = languageUtil.getResource("brightness");
    window.lang_D7_mode_title = languageUtil.getResource("mode");
    window.lang_D7_mode_dinner = languageUtil.getResource("mode_1");
    window.lang_D7_mode_moon =  languageUtil.getResource("mode_2");
    window.lang_D7_mode_blue = languageUtil.getResource("mode_3");
    window.lang_D7_mode_green = languageUtil.getResource("mode_4");
}
