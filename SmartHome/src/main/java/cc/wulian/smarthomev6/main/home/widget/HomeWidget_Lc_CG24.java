...
public class HomeWidget_Lc_CG24 extends RelativeLayout implements IWidgetLifeCycle {
    ...
    public HomeWidget_Lc_CG24(Context context) {
        super(context);
        initView(context);
    }
    ...
    private void initView(Context context) {
        ...
        View rootView = LayoutInflater.from(context).inflate(R.layout.view_home_lc_cg24, null);
        ...
        imageBg.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                LcPTZCameraActivity.start(HomeWidget_Lc_CG24.this.context, device.devID);
            }
        });
