(function() {
	...
	var gatewayCmd = {
        ...
        getHistory: function (params, onsucceed) {
            var callback = function(bridge) {
                bridge.callHandler("getBloodPressureHistory", params, onsucceed)
            }
            return B.exec(callback, _BARCODE, "getBloodPressureHistory");
        }
	};
