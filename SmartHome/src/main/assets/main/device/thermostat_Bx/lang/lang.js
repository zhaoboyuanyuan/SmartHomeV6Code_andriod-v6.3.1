 ...
 */
function globalLang() {
	window.Device_Bx_Details_Name = languageUtil.getResource("Device_Bx_Details_Name");
    window.Device_Bx_On = languageUtil.getResource("Device_Bx_On");//打开
    window.Device_Bx_Off = languageUtil.getResource("Device_Bx_Off");//关闭
	window.Device_Bx_Details_Time1 = languageUtil.getResource("Device_Bx_Details_Time1");
	window.Device_Bx_Details_Time2 = languageUtil.getResource("Device_Bx_Details_Time2");
	window.langEdit = languageUtil.getResource("Device_Bx_Details_Time3");
	window.langStart = languageUtil.getResource("Device_Bx_Details_Time4");
	window.langClose = languageUtil.getResource("Device_Bx_Details_Time5");
	window.langNotZero = languageUtil.getResource("Device_Bx_Details_Time6");
	window.langEditError = languageUtil.getResource("Device_Bx_Details_Time_TIPS1");
	window.langHour = languageUtil.getResource("Device_Bx_Details_Time7");
	window.langMin = languageUtil.getResource("Device_Bx_Details_Time8");
	window.langCancel = languageUtil.getResource("Device_Bx_Details_Cancel");
	window.langConfirm = languageUtil.getResource("Device_Bx_Details_Confirm");
	window.Device_Bx_Details_System = languageUtil.getResource("Device_Bx_Details_System");
	window.Device_Bx_Details_System3 = languageUtil.getResource("Device_Bx_Details_System3");
	window.Device_Bx_Details_System4 = languageUtil.getResource("Device_Bx_Details_System4");
	window.Device_Bx_Details_Return = languageUtil.getResource("Device_Bx_Details_Return");
	window.Device_Bx_Details_High_Protect = languageUtil.getResource("Device_Bx_Details_High_Protect");
	window.Device_Bx_Details_Low_Protect = languageUtil.getResource("Device_Bx_Details_Low_Protect");
	window.Device_Bx_Details_Restore = languageUtil.getResource("Device_Bx_Details_Restore");
