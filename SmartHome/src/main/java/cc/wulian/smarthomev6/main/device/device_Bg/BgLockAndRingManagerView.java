package cc.wulian.smarthomev6.main.device.device_Bg;


/*注意：
* 一键锁死功能某些锁是没有的，需要查询锁的参数信息才确定是否显示，
* 因为该功能是动态显示的，所以确定是否显示
* */
...
/**
 * Created by yuxx on 2017/9/20.
 * Bg锁的一键锁死及门铃免打扰功能
 */

public class BgLockAndRingManagerView extends RelativeLayout implements IDeviceMore {
    ...
    public BgLockAndRingManagerView(Context context){
        super(context);
    ...
    private void initView(Context context){
        rootView= LayoutInflater.from(context).inflate(R.layout.item_device_more_custom_bg_lockandring,null);
    ...
    View.OnClickListener onclick_setDoorbellTime=new View.OnClickListener(){
        @Override
        public void onClick(View v) {
            BgDoorNotDisturbTimeActivity.Start(BgLockAndRingManagerView.this.context,deviceID,curDoorbellTime);
        }
    };
    /**
     * 发送命令
