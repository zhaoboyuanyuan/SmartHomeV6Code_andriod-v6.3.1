(function() {
	...
	var gatewayCmd = {
        ...
        getWeightRecords: function(onsucceed) {
            var callback = function(bridge) {
                bridge.callHandler("getWeightRecords", onsucceed);
            }
            return B.exec(callback, _BARCODE, "getWeightRecords");
        },
        saveWeight: function(params,onsucceed) {
            var callback = function(bridge) {
                bridge.callHandler("saveWeight", params, onsucceed)
            }
            return B.exec(callback, _BARCODE, "saveWeight");
        },
	};
