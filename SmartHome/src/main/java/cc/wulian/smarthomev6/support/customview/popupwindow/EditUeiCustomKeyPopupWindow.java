...
/**
 * Created by 上海滩小马哥 on 2017/11/20.
 */

public class EditUeiCustomKeyPopupWindow {
    ...
    public EditUeiCustomKeyPopupWindow(Context context) {
        this.context = context;
        inflater = LayoutInflater.from(context);
        rootView = (LinearLayout) inflater.inflate(
                R.layout.pop_edit_uei_code, null);
...
//                    dismiss();
            ...
            rootView.findViewById(R.id.popup_rename).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    dismiss();
                    if (null != listener) {
                        listener.onRename(tag);
                    }
                }
            });

            rootView.findViewById(R.id.popup_delete_key).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    dismiss();
                    if (null != listener) {
