...
public class MiniGatewayConfigResultFragment extends WLFragment implements View.OnClickListener {
    ...
    public static MiniGatewayConfigResultFragment newInstance(String deviceId, int type, String scanEntry) {
        ...
        miniGatewayConfigResultFragment.setArguments(bundle);
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_connect_fail:
                ...
                if (type == 0) {
                    ...
                    ft.replace(android.R.id.content, miniGatewayGuideFragment, MiniGatewayConfigResultFragment.class.getName());
