 ...
 */
function globalLang() {
	window.lang_DoorSensorTittle	= languageUtil.getResource("DoorSensorTittle");
	window.lang_DoDefense       	= languageUtil.getResource("DoDefense");
	window.lang_InDefense       	= languageUtil.getResource("InDefense");
	window.lang_UnDefense       	= languageUtil.getResource("UnDefense");
	window.lang_OutOfDefense     	= languageUtil.getResource("OutOfDefense");
	window.lang_IsNormal        	= languageUtil.getResource("IsNormal");
	window.lang_DoorIsOpen      	= languageUtil.getResource("DoorIsOpen");
	window.lang_OffLine         	= languageUtil.getResource("OffLine");
	window.lang_Yesterday         	= languageUtil.getResource("Yesterday");
