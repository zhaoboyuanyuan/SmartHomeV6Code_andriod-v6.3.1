...
function globalLang() {
    ...
    window.device_Bg_title = languageUtil.getResource("device_Bg_title")//"保存"

    window.device_Bg_alarm_tit = languageUtil.getResource("device_bc_alarm_tit")//"报警设置";
    window.device_Bg_alarm_04 = languageUtil.getResource("device_bc_alarm_04")//"手机开锁";
    window.device_Bg_alarm_05 = languageUtil.getResource("device_bc_alarm_05")//"射频卡开锁";
    window.device_Bg_alarm_06 = languageUtil.getResource("device_bc_alarm_06")//"密码开锁";
    window.device_Bg_alarm_07 = languageUtil.getResource("device_bc_alarm_07")//"指纹开锁";
    window.device_Bg_alarm_08 = languageUtil.getResource("device_bc_alarm_08")//"反锁";
    window.device_Bg_alarm_09 = languageUtil.getResource("device_Bg_alarm_09")//"反锁";
    ...
    window.doorLock_Double_locked = languageUtil.getResource("doorLock_Double_locked")//"已反锁";
    window.doorLock_No_Double_locked = languageUtil.getResource("doorLock_No_Double_locked")//"未反锁";
