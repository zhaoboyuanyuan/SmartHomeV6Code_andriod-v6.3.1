 ...
 */
function globalLang() {
	window.unbound = languageUtil.getResource("Device_33_Details_Unbound");
	window.noBind = languageUtil.getResource("Device_33_Details_Bound");
	window.finished = languageUtil.getResource("Device_33_Details_Confirm");
	window.deviceDefaultName = languageUtil.getResource("Device_33_details_name");
}
