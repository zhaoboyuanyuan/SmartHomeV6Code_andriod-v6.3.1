 ...
 */
function globalLang() {
	window.addDevice_17_name = languageUtil.getResource("addDevice_17_name");
	window.lang_title_01 = languageUtil.getResource("humiture_title_01");
	window.lang_title_02 = languageUtil.getResource("humiture_title_02");
	window.lang_title_03 = languageUtil.getResource("humiture_title_03");
	window.lang_title_04 = languageUtil.getResource("humiture_title_04");
	window.lang_title_05 = languageUtil.getResource("humiture_title_05");
	window.lang_title_06 = languageUtil.getResource("humiture_title_06");
	window.lang_title_07 = languageUtil.getResource("humiture_title_07");
	window.lang_title_08 = languageUtil.getResource("humiture_title_08");
	window.lang_title_09 = languageUtil.getResource("humiture_title_09");
	window.lang_title_10 = languageUtil.getResource("humiture_title_10");
	window.lang_title_11 = languageUtil.getResource("humiture_title_11");
	window.lang_txt_01 = languageUtil.getResource("humiture_txt_01");
	window.lang_txt_02 = languageUtil.getResource("humiture_txt_02");
	window.lang_txt_03 = languageUtil.getResource("humiture_txt_03");
	window.lang_txt_04 = languageUtil.getResource("humiture_txt_04");
	window.lang_txt_05 = languageUtil.getResource("humiture_txt_05");
	window.lang_txt_06 = languageUtil.getResource("humiture_txt_06");
	window.lang_txt_07 = languageUtil.getResource("humiture_txt_07");
	window.lang_txt_08 = languageUtil.getResource("humiture_txt_08");
	window.lang_txt_09 = languageUtil.getResource("humiture_txt_09");
	window.lang_txt_10 = languageUtil.getResource("humiture_txt_10");
	window.history_temp = languageUtil.getResource("history_temp"); //"温度"
	window.history_hum = languageUtil.getResource("history_hum"); //"湿度"
