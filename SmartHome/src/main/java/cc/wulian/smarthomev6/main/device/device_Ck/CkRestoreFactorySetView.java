...
public class CkRestoreFactorySetView extends FrameLayout implements IDeviceMore, View.OnClickListener {
    ...
    public CkRestoreFactorySetView(Context context, String deviceID, String gwID) {
        super(context);
