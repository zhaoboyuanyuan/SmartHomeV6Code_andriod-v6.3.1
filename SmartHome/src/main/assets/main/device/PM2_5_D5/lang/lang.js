 ...
 */
function globalLang() {
    window.title_name = languageUtil.getResource("device_D5_name");
    window.device_state_1 = languageUtil.getResource("status_good");
    window.device_state_2 = languageUtil.getResource("status_medium");
    window.device_state_3 = languageUtil.getResource("status_bad");
    window.device_tip_1 = languageUtil.getResource("PM2_5_level_1");
    window.device_tip_2 = languageUtil.getResource("PM2_5_level_2");
    window.device_tip_3 = languageUtil.getResource("PM2_5_level_3");
    window.lang_hour = languageUtil.getResource("PM2_5_Statistics_h");
}
