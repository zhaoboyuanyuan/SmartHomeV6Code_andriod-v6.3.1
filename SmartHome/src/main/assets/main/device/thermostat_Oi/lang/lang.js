 ...
 */
function globalLang() {
    window.lang_name_Oi = languageUtil.getResource("Device_Oi_Details_Name")//""
    window.lang_Log = languageUtil.getResource("Log")//"日志"
    window.lang_Alarm = languageUtil.getResource("Alarm")//"报警消息"
    window.lang_Device_Oi_Details_Type = languageUtil.getResource("Device_Oi_Details_Type")//"模式";
    window.lang_Device_Oi_Details_Type1 = languageUtil.getResource("Device_Oi_Details_Type1");//"制冷";
    window.lang_Device_Oi_Details_Type2 = languageUtil.getResource("Device_Oi_Details_Type2");//"制热";
    window.lang_Device_Oi_Details_Type3 = languageUtil.getResource("Device_Oi_Details_Type3");//"送风";
    window.lang_Device_Oi_Details_Type4 = languageUtil.getResource("Device_Oi_Details_Type4");//"除湿";
    window.lang_Device_Oi_Details_Type5 = languageUtil.getResource("Device_Oi_Details_Type5");//"预热";
    window.lang_Device_Oi_Details_Type6 = languageUtil.getResource("Device_Oi_Details_Type6");//"自动";
    window.lang_Device_Oi_Details_Type7 = languageUtil.getResource("Device_Oi_Details_Type7");//"干燥";
    window.lang_Device_Oi_Details_Type8 = languageUtil.getResource("Device_Oi_Details_Type8");//"清爽";
    window.lang_Device_Oi_Details_Type9 = languageUtil.getResource("Device_Oi_Details_Type9");//"睡眠";
    window.lang_Device_Oi_Details_Type10 = languageUtil.getResource("Device_Oi_Details_Type10");//"杀菌";
    window.lang_Device_Oi_Details_Type11 = languageUtil.getResource("Device_Oi_Details_Type11");//"干爽除湿";
    window.lang_Device_Oi_Details_Type12 = languageUtil.getResource("Device_Oi_Details_Type12");// "强力除湿";
    window.lang_Device_Oi_Details_Speed = languageUtil.getResource("Device_Oi_Details_Speed")//"风速";

    window.lang_Device_Oi_Details_Speed4 = languageUtil.getResource("Device_Oi_Details_Speed4")//"自动";

    window.lang_Device_Oi_Details_Direction = languageUtil.getResource("Device_Oi_Details_Direction")//"风向";
}
