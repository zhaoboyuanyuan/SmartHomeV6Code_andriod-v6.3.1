...
//	window.getItem();window.setItem()
	...
	for(var i=0;i<12;i++){
        btnList[i].children[0].addEventListener("touchstart",function(){
            ...
            if(this.parentNode.id === "lockKeyBoard_Clean"){
			...
			}else if(this.parentNode.id === "lockKeyBoard_Submit"){
...
//			未输入密码状态
            ...
            document.getElementById("lockKeyBoard_Clean").style.backgroundSize = "1.8rem auto";
			var doorLock_open_nor = "#e5e5e5 url(../fonts/icon_doorLock_open_nor.png) no-repeat center center";
			document.getElementById("lockKeyBoard_Submit").style.background = doorLock_open_nor;
            document.getElementById("lockKeyBoard_Submit").style.backgroundSize = "3rem auto";
		}
