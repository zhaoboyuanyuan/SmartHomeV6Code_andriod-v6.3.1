		...
		if(item[i].type == "search" && item[i].placeholder != "" && item[i].localName == "input") {
			...
			if(languagerText) {
				if(item[i].type == "button") {
					...
					if (item[i].getAttribute("key") == 'noBind') {
 ...
 */
function globalLang() {
	window.noBinding = languageUtil.getResource("Device_Bi_Details_Unbound");
	window.Device_Bi_Details_Notbound = languageUtil.getResource("Device_Bi_Details_Notbound");
	window.Device_Bi_details_name = languageUtil.getResource("Device_Bi_details_name");
	window.Device_Bi_Details_Confirm = languageUtil.getResource("Device_Bi_Details_Confirm");
	window.deviceDefaultName = languageUtil.getResource("Device_Bi_details_name");
	window.bindTip = languageUtil.getResource("bindTip");
}
