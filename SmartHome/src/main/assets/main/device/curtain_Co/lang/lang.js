 ...
 */
function globalLang() {
	window.device_Co_name = languageUtil.getResource("device_Co_name");
    window.lang_Log 	= languageUtil.getResource("Log");
    window.lang_Alarm = languageUtil.getResource("Alarm");
	window.Prompt = languageUtil.getResource("Device_Co_Details_Prompt");
	window.Bind_ok = languageUtil.getResource("Bind_ok");
	window.no_place_hint = languageUtil.getResource("device_Co_no_place_hint");
	window.i_know = languageUtil.getResource("Add_batches_i_know");
}
