...
public class BroadcastTimeAdapter extends WLBaseAdapter<String> {
    ...
    public BroadcastTimeAdapter(Context context, List<String> data) {
        super(context, data);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        BroadcastTimeAdapter.ViewHolder holder = null;
        if (convertView == null) {
            holder = new BroadcastTimeAdapter.ViewHolder();
            ...
            holder = (BroadcastTimeAdapter.ViewHolder) convertView.getTag();
        }
