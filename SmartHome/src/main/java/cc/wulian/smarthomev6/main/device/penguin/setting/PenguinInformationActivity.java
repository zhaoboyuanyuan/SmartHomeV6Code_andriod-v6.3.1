...
public class PenguinInformationActivity extends BaseTitleActivity implements View.OnClickListener, IcamMsgEventHandler {
    ...
    private LinearLayout llWiFiStrength;
    private LinearLayout llWiFiName;
    private LinearLayout llItemIp;
    private LinearLayout llItemMac;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.activity_penguin_information, true);
    ...
    protected void initView() {
        ...
        llWiFiName = (LinearLayout) findViewById(R.id.ll_connect_wifi);
        llWiFiStrength = (LinearLayout) findViewById(R.id.ll_wifi_strength);
        llItemIp = (LinearLayout) findViewById(R.id.ll_item_ip);
        llItemMac = (LinearLayout) findViewById(R.id.ll_item_mac);
    ...
    protected void initData() {
        ...
        if (TextUtils.equals(iCamDeviceBean.type, "CMICA6")) {
            llWiFiName.setVisibility(View.GONE);
            llWiFiStrength.setVisibility(View.GONE);
            llItemIp.setVisibility(View.GONE);
            llItemMac.setVisibility(View.GONE);
            tvDeviceType.setText(getString(R.string.Device_Default_Name_CMICA6));
        }
