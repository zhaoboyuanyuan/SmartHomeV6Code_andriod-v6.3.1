...
public class BiometricPromptApi28{
...
//                .Builder(activity)
//                .setTitle(activity.getResources().getString(R.string.Sure))
//                .setDescription(activity.getResources().getString(R.string.device_HS05_title))
//                .setSubtitle("")
