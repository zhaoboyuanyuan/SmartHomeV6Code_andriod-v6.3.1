...
public class HomeWidget_25_Extraman extends RelativeLayout implements IWidgetLifeCycle, View.OnClickListener {

    private static final String TAG = HomeWidget_25_Extraman.class.getSimpleName();
    private Device mDevice;
    private HomeItemBean mHomeItemBean;

    private TextView textName, textState, textArea, state_text;
    private ImageView iv_one_switch, extraman_image;
    ...
    public HomeWidget_25_Extraman(Context context) {
        super(context);
        mContext = context;
        initView(context);
    }

    public HomeWidget_25_Extraman(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView(context);
    }
    ...
    private void initView(Context context) {
        final View rootView = LayoutInflater.from(context).inflate(R.layout.view_home_25_extraman, null);
        ...
        extraman_image = (ImageView) rootView.findViewById(R.id.extraman_image);
...
//        sendCmd(2);//获取所有状态信息
    ...
    private void updateSwitchState(String state) {
        ...
        switch (state) {
            case "1":
//                openState = 1;
//                extraman_image.setImageResource(R.drawable.icon_device_25_abnormity);
                break;
            case "2":
                openState = 2;
                ...
                extraman_image.setImageResource(R.drawable.icon_device_25_open);
            ...
            case "3":
                ...
                extraman_image.setImageResource(R.drawable.icon_device_25_close);
                state_text.setText(R.string.Device_Lock_Widget_Gatestatusa);
                break;
            case "4":
                openState = 4;
                extraman_image.setImageResource(R.drawable.icon_device_25_abnormity);
                state_text.setText(R.string.Home_Widget_Unknownstate);
                break;
            case "5":
                openState = 5;
                extraman_image.setImageResource(R.drawable.icon_device_25_abnormity);
