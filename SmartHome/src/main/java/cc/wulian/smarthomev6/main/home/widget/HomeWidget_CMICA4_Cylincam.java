...
public class HomeWidget_CMICA4_Cylincam extends RelativeLayout implements IWidgetLifeCycle {
    ...
    private void initView(final Context context) {
        View rootView = LayoutInflater.from(context).inflate(R.layout.view_home_cmica4_cylincam, null);
        ...
        textState.setVisibility(GONE);

        rootView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                CylincamPlayActivity.start(context, mDevice.devID);
            }
        });
    }
